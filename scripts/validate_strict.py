#!/usr/bin/env python3
"""Strict LinkML validation harness for CellStructureMech instance records.
...
CellStructureMech has a single root class (CellStructureRecord); no class routing required.
"""
...
SCHEMA_PATH = _REPO_ROOT / "src" / "cellstructuremech" / "schema" / "cellstructuremech.yaml"
DEFAULT_ROOTS = [_REPO_ROOT / "data" / "structures"]
TARGET_CLASS = "CellStructureRecord"
...
def main() -> int:
    ...
    parser.add_argument("paths", nargs="*", type=Path,
                        help="Files or directories. Defaults to data/structures/.")
