...
The schema is already vendored at `src/cellstructuremech/schema/history.yaml`, which is
...
Usage:
    python scripts/new_history_record.py --kind record --slug cellulolysis \\
        --target-root data/structures/metabolism --event EDIT --outcome changed \\
...
REPO_URL = "https://github.com/CultureBotAI/CellStructureMech"
