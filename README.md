...
**397 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 397 |
| OTHER | 72 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
343 records are grounded in GO; 54 carry minted identifiers. 331 list components, 397 carry causal graphs (1785 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
