...
**132 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 33 | | PROPOSED | 132 |
| MEMBRANE_ORGANELLE | 25 | |  |  |
| OTHER | 18 | |  |  |
| CYTOSKELETON | 16 | |  |  |
| SECRETION_SYSTEM | 9 | |  |  |
| ENVELOPE | 8 | |  |  |
...
101 records are grounded in GO; 31 carry minted identifiers. 132 list components, 132 carry causal graphs (739 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
