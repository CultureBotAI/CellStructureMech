...
**311 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 148 | | PROPOSED | 311 |
| APPENDAGE | 38 | |  |  |
| OTHER | 36 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 12 | |  |  |
...
257 records are grounded in GO; 54 carry minted identifiers. 262 list components, 311 carry causal graphs (1371 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
