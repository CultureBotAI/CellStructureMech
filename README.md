...
**247 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 90 | | PROPOSED | 247 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
207 records are grounded in GO; 40 carry minted identifiers. 225 list components, 247 carry causal graphs (1187 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
