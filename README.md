...
**70 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 70 |
...
64 records are grounded in GO; 6 carry minted identifiers. 70 list components, 70 carry causal graphs (485 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
