...
**451 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 191 | | PROPOSED | 451 |
| OTHER | 95 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 38 | |  |  |
| SPORE | 17 | |  |  |
...
393 records are grounded in GO; 58 carry minted identifiers. 367 list components, 450 carry causal graphs (1998 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
