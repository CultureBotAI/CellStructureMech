...
**33 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 5 | | PROPOSED | 33 |
| SECRETION_SYSTEM | 5 | |  |  |
| APPENDAGE | 4 | |  |  |
| ENVELOPE | 4 | |  |  |
| MICROCOMPARTMENT | 4 | |  |  |
...
31 records are grounded in GO; 2 carry minted identifiers. 33 list components, 33 carry causal graphs (238 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
