...
**598 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 598 |
| OTHER | 130 | |  |  |
...
531 records are grounded in GO; 67 carry minted identifiers. 488 list components, 597 carry causal graphs (2607 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
