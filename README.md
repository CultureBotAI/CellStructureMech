...
**316 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 153 | | PROPOSED | 316 |
| APPENDAGE | 38 | |  |  |
| OTHER | 36 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 12 | |  |  |
...
262 records are grounded in GO; 54 carry minted identifiers. 264 list components, 316 carry causal graphs (1393 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
