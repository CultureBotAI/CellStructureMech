...
**393 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 393 |
| OTHER | 68 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
339 records are grounded in GO; 54 carry minted identifiers. 327 list components, 393 carry causal graphs (1764 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
