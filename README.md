...
**170 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 41 | | PROPOSED | 170 |
| APPENDAGE | 34 | |  |  |
| OTHER | 26 | |  |  |
| CYTOSKELETON | 19 | |  |  |
| ENVELOPE | 10 | |  |  |
...
138 records are grounded in GO; 32 carry minted identifiers. 170 list components, 170 carry causal graphs (951 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
