...
**440 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 186 | | PROPOSED | 440 |
| OTHER | 95 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 38 | |  |  |
| ENVELOPE | 15 | |  |  |
...
382 records are grounded in GO; 58 carry minted identifiers. 363 list components, 440 carry causal graphs (1967 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
