...
**292 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 133 | | PROPOSED | 292 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
243 records are grounded in GO; 49 carry minted identifiers. 255 list components, 292 carry causal graphs (1321 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
