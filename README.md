...
**582 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 582 |
| OTHER | 114 | |  |  |
| RIBONUCLEOPROTEIN | 69 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
| SPORE | 21 | |  |  |
...
515 records are grounded in GO; 67 carry minted identifiers. 472 list components, 581 carry causal graphs (2485 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
