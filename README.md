...
**50 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 12 | | PROPOSED | 50 |
| SECRETION_SYSTEM | 9 | |  |  |
...
44 records are grounded in GO; 6 carry minted identifiers. 50 list components, 50 carry causal graphs (351 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
