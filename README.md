...
**591 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 591 |
| OTHER | 123 | |  |  |
...
524 records are grounded in GO; 67 carry minted identifiers. 481 list components, 590 carry causal graphs (2535 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
