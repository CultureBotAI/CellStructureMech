...
**122 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 28 | | PROPOSED | 122 |
...
99 records are grounded in GO; 23 carry minted identifiers. 122 list components, 122 carry causal graphs (698 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
