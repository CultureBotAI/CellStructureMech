...
**78 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 78 |
...
70 records are grounded in GO; 8 carry minted identifiers. 78 list components, 78 carry causal graphs (527 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
