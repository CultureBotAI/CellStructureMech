...
**101 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 28 | | PROPOSED | 101 |
...
86 records are grounded in GO; 15 carry minted identifiers. 101 list components, 101 carry causal graphs (621 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
