...
**474 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 193 | | PROPOSED | 474 |
| OTHER | 95 | |  |  |
| CYTOSKELETON | 48 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 20 | |  |  |
...
408 records are grounded in GO; 66 carry minted identifiers. 389 list components, 473 carry causal graphs (2107 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
