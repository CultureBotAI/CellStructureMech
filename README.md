...
**54 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 16 | | PROPOSED | 54 |
| SECRETION_SYSTEM | 9 | |  |  |
...
48 records are grounded in GO; 6 carry minted identifiers. 54 list components, 54 carry causal graphs (374 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
