...
**259 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 102 | | PROPOSED | 259 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
212 records are grounded in GO; 47 carry minted identifiers. 232 list components, 259 carry causal graphs (1218 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
