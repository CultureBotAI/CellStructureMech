...
**431 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 179 | | PROPOSED | 431 |
| OTHER | 95 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 37 | |  |  |
| ENVELOPE | 14 | |  |  |
...
373 records are grounded in GO; 58 carry minted identifiers. 355 list components, 431 carry causal graphs (1926 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
