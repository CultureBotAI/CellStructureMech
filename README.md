...
**600 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 600 |
| OTHER | 132 | |  |  |
...
533 records are grounded in GO; 67 carry minted identifiers. 490 list components, 599 carry causal graphs (2616 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
