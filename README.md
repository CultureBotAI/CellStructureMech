...
**606 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 606 |
| OTHER | 138 | |  |  |
...
539 records are grounded in GO; 67 carry minted identifiers. 496 list components, 605 carry causal graphs (2638 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
