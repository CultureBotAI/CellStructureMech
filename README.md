...
**420 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 420 |
| OTHER | 94 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 32 | |  |  |
| ENVELOPE | 14 | |  |  |
...
366 records are grounded in GO; 54 carry minted identifiers. 344 list components, 420 carry causal graphs (1887 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
