...
**57 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 19 | | PROPOSED | 57 |
| SECRETION_SYSTEM | 9 | |  |  |
...
51 records are grounded in GO; 6 carry minted identifiers. 57 list components, 57 carry causal graphs (398 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
