...
**164 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 40 | | PROPOSED | 164 |
| APPENDAGE | 34 | |  |  |
| OTHER | 25 | |  |  |
| CYTOSKELETON | 18 | |  |  |
| ENVELOPE | 10 | |  |  |
...
132 records are grounded in GO; 32 carry minted identifiers. 164 list components, 164 carry causal graphs (926 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
