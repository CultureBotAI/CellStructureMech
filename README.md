...
**120 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 28 | | PROPOSED | 120 |
...
99 records are grounded in GO; 21 carry minted identifiers. 120 list components, 120 carry causal graphs (693 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
