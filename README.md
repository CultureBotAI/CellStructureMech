...
**126 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 29 | | PROPOSED | 126 |
| MEMBRANE_ORGANELLE | 23 | |  |  |
| OTHER | 18 | |  |  |
| CYTOSKELETON | 16 | |  |  |
| SECRETION_SYSTEM | 9 | |  |  |
| ENVELOPE | 8 | |  |  |
...
100 records are grounded in GO; 26 carry minted identifiers. 126 list components, 126 carry causal graphs (716 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
