...
**111 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 28 | | PROPOSED | 111 |
...
96 records are grounded in GO; 15 carry minted identifiers. 111 list components, 111 carry causal graphs (663 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
