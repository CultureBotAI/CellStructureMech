...
**100 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 28 | | PROPOSED | 100 |
...
85 records are grounded in GO; 15 carry minted identifiers. 100 list components, 100 carry causal graphs (617 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
