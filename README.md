...
**234 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 77 | | PROPOSED | 234 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
195 records are grounded in GO; 39 carry minted identifiers. 217 list components, 234 carry causal graphs (1155 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
