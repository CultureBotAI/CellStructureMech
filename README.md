...
**502 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 502 |
| OTHER | 103 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 21 | |  |  |
...
436 records are grounded in GO; 66 carry minted identifiers. 400 list components, 501 carry causal graphs (2228 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
