...
**378 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 378 |
| OTHER | 53 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
324 records are grounded in GO; 54 carry minted identifiers. 312 list components, 378 carry causal graphs (1651 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
