...
**160 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 40 | | PROPOSED | 160 |
| APPENDAGE | 34 | |  |  |
| OTHER | 22 | |  |  |
| CYTOSKELETON | 18 | |  |  |
| ENVELOPE | 10 | |  |  |
...
128 records are grounded in GO; 32 carry minted identifiers. 160 list components, 160 carry causal graphs (897 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
