...
**300 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 141 | | PROPOSED | 300 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
249 records are grounded in GO; 51 carry minted identifiers. 259 list components, 300 carry causal graphs (1339 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
