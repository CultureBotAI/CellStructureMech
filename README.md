...
**432 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 179 | | PROPOSED | 432 |
| OTHER | 95 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 38 | |  |  |
| ENVELOPE | 14 | |  |  |
...
374 records are grounded in GO; 58 carry minted identifiers. 356 list components, 432 carry causal graphs (1932 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
