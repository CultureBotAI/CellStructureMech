...
**497 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 497 |
| OTHER | 102 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 21 | |  |  |
...
431 records are grounded in GO; 66 carry minted identifiers. 395 list components, 496 carry causal graphs (2203 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
