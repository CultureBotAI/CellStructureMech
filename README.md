...
**533 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 533 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
...
466 records are grounded in GO; 67 carry minted identifiers. 431 list components, 532 carry causal graphs (2360 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
