...
**207 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 68 | | PROPOSED | 207 |
| APPENDAGE | 36 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
175 records are grounded in GO; 32 carry minted identifiers. 202 list components, 207 carry causal graphs (1063 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
