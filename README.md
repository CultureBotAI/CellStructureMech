...
**367 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 172 | | PROPOSED | 367 |
| OTHER | 47 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
313 records are grounded in GO; 54 carry minted identifiers. 305 list components, 367 carry causal graphs (1600 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
