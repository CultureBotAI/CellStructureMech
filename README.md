...
**375 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 375 |
| OTHER | 50 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
321 records are grounded in GO; 54 carry minted identifiers. 309 list components, 375 carry causal graphs (1632 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
