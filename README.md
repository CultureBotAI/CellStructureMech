...
**102 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 28 | | PROPOSED | 102 |
...
87 records are grounded in GO; 15 carry minted identifiers. 102 list components, 102 carry causal graphs (627 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
