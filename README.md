...
**350 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 163 | | PROPOSED | 350 |
| OTHER | 43 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 30 | |  |  |
| ENVELOPE | 13 | |  |  |
...
296 records are grounded in GO; 54 carry minted identifiers. 288 list components, 350 carry causal graphs (1521 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
