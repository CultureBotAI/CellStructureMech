...
**322 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 158 | | PROPOSED | 322 |
| APPENDAGE | 38 | |  |  |
| OTHER | 36 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 12 | |  |  |
...
268 records are grounded in GO; 54 carry minted identifiers. 268 list components, 322 carry causal graphs (1429 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
