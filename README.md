...
**98 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 27 | | PROPOSED | 98 |
...
84 records are grounded in GO; 14 carry minted identifiers. 98 list components, 98 carry causal graphs (610 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
