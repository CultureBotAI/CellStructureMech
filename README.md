...
**418 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 418 |
| OTHER | 92 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 32 | |  |  |
| ENVELOPE | 14 | |  |  |
...
364 records are grounded in GO; 54 carry minted identifiers. 342 list components, 418 carry causal graphs (1872 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
