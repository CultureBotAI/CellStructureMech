...
**109 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 28 | | PROPOSED | 109 |
...
94 records are grounded in GO; 15 carry minted identifiers. 109 list components, 109 carry causal graphs (658 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
