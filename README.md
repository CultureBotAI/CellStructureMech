...
**404 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 404 |
| OTHER | 79 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
350 records are grounded in GO; 54 carry minted identifiers. 337 list components, 404 carry causal graphs (1819 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
