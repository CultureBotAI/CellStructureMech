...
**424 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 178 | | PROPOSED | 424 |
| OTHER | 94 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 33 | |  |  |
| ENVELOPE | 14 | |  |  |
...
369 records are grounded in GO; 55 carry minted identifiers. 348 list components, 424 carry causal graphs (1903 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
