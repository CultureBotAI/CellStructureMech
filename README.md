...
**428 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 178 | | PROPOSED | 428 |
| OTHER | 95 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 36 | |  |  |
| ENVELOPE | 14 | |  |  |
...
371 records are grounded in GO; 57 carry minted identifiers. 352 list components, 428 carry causal graphs (1917 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
