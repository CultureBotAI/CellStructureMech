...
**465 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 193 | | PROPOSED | 465 |
| OTHER | 95 | |  |  |
| APPENDAGE | 42 | |  |  |
| CYTOSKELETON | 39 | |  |  |
| SPORE | 20 | |  |  |
...
399 records are grounded in GO; 66 carry minted identifiers. 381 list components, 464 carry causal graphs (2068 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
