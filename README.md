...
**39 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 6 | | PROPOSED | 39 |
...
36 records are grounded in GO; 3 carry minted identifiers. 39 list components, 39 carry causal graphs (279 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
