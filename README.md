...
**178 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 44 | | PROPOSED | 178 |
| APPENDAGE | 34 | |  |  |
| OTHER | 27 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 10 | |  |  |
...
146 records are grounded in GO; 32 carry minted identifiers. 178 list components, 178 carry causal graphs (980 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
