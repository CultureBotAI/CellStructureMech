...
**357 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 166 | | PROPOSED | 357 |
| OTHER | 44 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENERGY_COMPLEX | 13 | |  |  |
...
303 records are grounded in GO; 54 carry minted identifiers. 295 list components, 357 carry causal graphs (1552 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
