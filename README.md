...
**10 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| ENVELOPE | 4 | | PROPOSED | 10 |
| APPENDAGE | 2 | |  |  |
| INCLUSION | 1 | |  |  |
| MICROCOMPARTMENT | 1 | |  |  |
| NUCLEOID | 1 | |  |  |
...
10 records are grounded in GO; 0 carry minted identifiers. 10 list components, 3 carry causal graphs (16 evidence-backed edges), 3 link to TraitMech traits, and 4 carry licensed, cited imaging evidence.
