...
**403 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 403 |
| OTHER | 78 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
349 records are grounded in GO; 54 carry minted identifiers. 337 list components, 403 carry causal graphs (1816 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
