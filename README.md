...
**386 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 386 |
| OTHER | 61 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
332 records are grounded in GO; 54 carry minted identifiers. 320 list components, 386 carry causal graphs (1705 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
