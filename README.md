...
**198 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 60 | | PROPOSED | 198 |
| APPENDAGE | 35 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
166 records are grounded in GO; 32 carry minted identifiers. 197 list components, 198 carry causal graphs (1043 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
