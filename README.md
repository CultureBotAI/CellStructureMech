...
**509 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 509 |
| OTHER | 103 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 24 | |  |  |
...
442 records are grounded in GO; 67 carry minted identifiers. 407 list components, 508 carry causal graphs (2278 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
