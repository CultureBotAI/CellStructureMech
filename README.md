...
**442 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 188 | | PROPOSED | 442 |
| OTHER | 95 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 38 | |  |  |
| ENVELOPE | 15 | |  |  |
...
384 records are grounded in GO; 58 carry minted identifiers. 364 list components, 442 carry causal graphs (1976 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
