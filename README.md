...
**200 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 62 | | PROPOSED | 200 |
| APPENDAGE | 35 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
168 records are grounded in GO; 32 carry minted identifiers. 198 list components, 200 carry causal graphs (1048 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
