...
**176 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 43 | | PROPOSED | 176 |
| APPENDAGE | 34 | |  |  |
| OTHER | 26 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 10 | |  |  |
...
144 records are grounded in GO; 32 carry minted identifiers. 176 list components, 176 carry causal graphs (973 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
