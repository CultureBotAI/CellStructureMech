...
**422 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 422 |
| OTHER | 94 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 33 | |  |  |
| ENVELOPE | 14 | |  |  |
...
367 records are grounded in GO; 55 carry minted identifiers. 346 list components, 422 carry causal graphs (1895 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
