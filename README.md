...
**333 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 159 | | PROPOSED | 333 |
| APPENDAGE | 40 | |  |  |
| OTHER | 40 | |  |  |
| CYTOSKELETON | 24 | |  |  |
| ENERGY_COMPLEX | 12 | |  |  |
...
279 records are grounded in GO; 54 carry minted identifiers. 276 list components, 333 carry causal graphs (1471 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
