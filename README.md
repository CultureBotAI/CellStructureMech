...
**523 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 523 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
...
456 records are grounded in GO; 67 carry minted identifiers. 421 list components, 522 carry causal graphs (2335 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
