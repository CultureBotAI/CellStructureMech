...
**321 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 158 | | PROPOSED | 321 |
| APPENDAGE | 38 | |  |  |
| OTHER | 36 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 12 | |  |  |
...
267 records are grounded in GO; 54 carry minted identifiers. 267 list components, 321 carry causal graphs (1425 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
