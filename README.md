...
**332 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 159 | | PROPOSED | 332 |
| APPENDAGE | 40 | |  |  |
| OTHER | 40 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENERGY_COMPLEX | 12 | |  |  |
...
278 records are grounded in GO; 54 carry minted identifiers. 275 list components, 332 carry causal graphs (1468 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
