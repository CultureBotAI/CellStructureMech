...
**452 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 191 | | PROPOSED | 452 |
| OTHER | 95 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 38 | |  |  |
| SPORE | 18 | |  |  |
...
394 records are grounded in GO; 58 carry minted identifiers. 368 list components, 451 carry causal graphs (2002 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
