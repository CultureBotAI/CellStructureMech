...
**492 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 492 |
| OTHER | 99 | |  |  |
| CYTOSKELETON | 58 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 21 | |  |  |
...
426 records are grounded in GO; 66 carry minted identifiers. 395 list components, 491 carry causal graphs (2174 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
