...
**148 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 34 | | PROPOSED | 148 |
| APPENDAGE | 33 | |  |  |
| OTHER | 20 | |  |  |
| CYTOSKELETON | 17 | |  |  |
| SECRETION_SYSTEM | 10 | |  |  |
...
116 records are grounded in GO; 32 carry minted identifiers. 148 list components, 148 carry causal graphs (818 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
