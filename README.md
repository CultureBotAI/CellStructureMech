...
**139 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 33 | | PROPOSED | 139 |
| MEMBRANE_ORGANELLE | 30 | |  |  |
| OTHER | 18 | |  |  |
| CYTOSKELETON | 17 | |  |  |
| SECRETION_SYSTEM | 10 | |  |  |
| ENVELOPE | 8 | |  |  |
...
107 records are grounded in GO; 32 carry minted identifiers. 139 list components, 139 carry causal graphs (771 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
