...
**128 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 29 | | PROPOSED | 128 |
...
101 records are grounded in GO; 27 carry minted identifiers. 128 list components, 128 carry causal graphs (724 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
