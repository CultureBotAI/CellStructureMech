...
**77 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 77 |
| MEMBRANE_ORGANELLE | 15 | |  |  |
| SECRETION_SYSTEM | 9 | |  |  |
| MICROCOMPARTMENT | 6 | |  |  |
| CYTOSKELETON | 4 | |  |  |
| ENVELOPE | 4 | |  |  |
...
70 records are grounded in GO; 7 carry minted identifiers. 77 list components, 77 carry causal graphs (524 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
