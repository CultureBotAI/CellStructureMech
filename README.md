...
**204 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 66 | | PROPOSED | 204 |
| APPENDAGE | 35 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
172 records are grounded in GO; 32 carry minted identifiers. 201 list components, 204 carry causal graphs (1057 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
