...
**578 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 578 |
| OTHER | 112 | |  |  |
| RIBONUCLEOPROTEIN | 67 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
| SPORE | 21 | |  |  |
...
511 records are grounded in GO; 67 carry minted identifiers. 468 list components, 577 carry causal graphs (2470 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
