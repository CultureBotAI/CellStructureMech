...
**484 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 194 | | PROPOSED | 484 |
| OTHER | 95 | |  |  |
| CYTOSKELETON | 57 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 20 | |  |  |
...
418 records are grounded in GO; 66 carry minted identifiers. 391 list components, 483 carry causal graphs (2146 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
