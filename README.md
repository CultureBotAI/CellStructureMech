...
**334 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 159 | | PROPOSED | 334 |
| APPENDAGE | 40 | |  |  |
| OTHER | 40 | |  |  |
| CYTOSKELETON | 25 | |  |  |
| ENERGY_COMPLEX | 12 | |  |  |
...
280 records are grounded in GO; 54 carry minted identifiers. 277 list components, 334 carry causal graphs (1475 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
