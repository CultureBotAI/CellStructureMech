...
**588 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 588 |
| OTHER | 120 | |  |  |
...
521 records are grounded in GO; 67 carry minted identifiers. 478 list components, 587 carry causal graphs (2526 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
