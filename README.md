...
**595 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 595 |
| OTHER | 127 | |  |  |
...
528 records are grounded in GO; 67 carry minted identifiers. 485 list components, 594 carry causal graphs (2571 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
