...
**537 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 537 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| RIBONUCLEOPROTEIN | 30 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
| SPORE | 21 | |  |  |
| ENVELOPE | 16 | |  |  |
| SECRETION_SYSTEM | 15 | |  |  |
...
470 records are grounded in GO; 67 carry minted identifiers. 435 list components, 536 carry causal graphs (2367 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
