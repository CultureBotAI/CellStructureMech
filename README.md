...
**435 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 181 | | PROPOSED | 435 |
| OTHER | 95 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 38 | |  |  |
| ENVELOPE | 15 | |  |  |
...
377 records are grounded in GO; 58 carry minted identifiers. 359 list components, 435 carry causal graphs (1943 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
