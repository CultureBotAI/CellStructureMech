...
**468 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 193 | | PROPOSED | 468 |
| OTHER | 95 | |  |  |
| APPENDAGE | 42 | |  |  |
| CYTOSKELETON | 42 | |  |  |
| SPORE | 20 | |  |  |
...
402 records are grounded in GO; 66 carry minted identifiers. 384 list components, 467 carry causal graphs (2083 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
