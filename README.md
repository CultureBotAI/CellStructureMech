...
**275 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 116 | | PROPOSED | 275 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
226 records are grounded in GO; 49 carry minted identifiers. 242 list components, 275 carry causal graphs (1263 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
