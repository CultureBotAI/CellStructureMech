...
**268 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 110 | | PROPOSED | 268 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
219 records are grounded in GO; 49 carry minted identifiers. 237 list components, 268 carry causal graphs (1243 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
