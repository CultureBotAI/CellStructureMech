...
**551 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 551 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| RIBONUCLEOPROTEIN | 44 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
| SPORE | 21 | |  |  |
| ENVELOPE | 16 | |  |  |
...
484 records are grounded in GO; 67 carry minted identifiers. 449 list components, 550 carry causal graphs (2397 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
