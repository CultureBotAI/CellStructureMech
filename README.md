...
**171 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 41 | | PROPOSED | 171 |
| APPENDAGE | 34 | |  |  |
| OTHER | 26 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 10 | |  |  |
...
139 records are grounded in GO; 32 carry minted identifiers. 171 list components, 171 carry causal graphs (957 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
