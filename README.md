...
**412 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 412 |
| OTHER | 87 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
358 records are grounded in GO; 54 carry minted identifiers. 337 list components, 412 carry causal graphs (1840 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
