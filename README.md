...
**526 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 526 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
| SPORE | 21 | |  |  |
| RIBONUCLEOPROTEIN | 19 | |  |  |
| ENVELOPE | 16 | |  |  |
| SECRETION_SYSTEM | 15 | |  |  |
| INCLUSION | 11 | |  |  |
| MICROCOMPARTMENT | 6 | |  |  |
...
459 records are grounded in GO; 67 carry minted identifiers. 424 list components, 525 carry causal graphs (2343 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
