...
**157 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 37 | | PROPOSED | 157 |
| APPENDAGE | 34 | |  |  |
| OTHER | 22 | |  |  |
| CYTOSKELETON | 18 | |  |  |
| ENVELOPE | 10 | |  |  |
...
125 records are grounded in GO; 32 carry minted identifiers. 157 list components, 157 carry causal graphs (872 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
