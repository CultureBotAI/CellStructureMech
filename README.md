...
**273 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 115 | | PROPOSED | 273 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
224 records are grounded in GO; 49 carry minted identifiers. 241 list components, 273 carry causal graphs (1256 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
