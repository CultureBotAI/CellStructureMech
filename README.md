...
**196 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 58 | | PROPOSED | 196 |
| APPENDAGE | 35 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
164 records are grounded in GO; 32 carry minted identifiers. 195 list components, 196 carry causal graphs (1037 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
