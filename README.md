...
**80 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 80 |
...
71 records are grounded in GO; 9 carry minted identifiers. 80 list components, 80 carry causal graphs (533 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
