...
**249 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 92 | | PROPOSED | 249 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
209 records are grounded in GO; 40 carry minted identifiers. 226 list components, 249 carry causal graphs (1193 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
