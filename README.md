...
**217 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 75 | | PROPOSED | 217 |
| APPENDAGE | 36 | |  |  |
| OTHER | 30 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
185 records are grounded in GO; 32 carry minted identifiers. 208 list components, 217 carry causal graphs (1089 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
