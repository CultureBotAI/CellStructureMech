...
**490 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 490 |
| OTHER | 98 | |  |  |
| CYTOSKELETON | 58 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 20 | |  |  |
...
424 records are grounded in GO; 66 carry minted identifiers. 395 list components, 489 carry causal graphs (2167 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
