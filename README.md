...
**282 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 123 | | PROPOSED | 282 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
233 records are grounded in GO; 49 carry minted identifiers. 246 list components, 282 carry causal graphs (1287 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
