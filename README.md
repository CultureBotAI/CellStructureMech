...
**283 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 124 | | PROPOSED | 283 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
234 records are grounded in GO; 49 carry minted identifiers. 247 list components, 283 carry causal graphs (1291 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
