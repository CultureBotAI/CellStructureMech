...
**437 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 183 | | PROPOSED | 437 |
| OTHER | 95 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 38 | |  |  |
| ENVELOPE | 15 | |  |  |
...
379 records are grounded in GO; 58 carry minted identifiers. 361 list components, 437 carry causal graphs (1958 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
