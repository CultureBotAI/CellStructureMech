...
**395 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 395 |
| OTHER | 70 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
341 records are grounded in GO; 54 carry minted identifiers. 329 list components, 395 carry causal graphs (1776 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
