...
**104 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 28 | | PROPOSED | 104 |
...
89 records are grounded in GO; 15 carry minted identifiers. 104 list components, 104 carry causal graphs (636 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
