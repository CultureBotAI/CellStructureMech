...
**416 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 416 |
| OTHER | 91 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
362 records are grounded in GO; 54 carry minted identifiers. 339 list components, 416 carry causal graphs (1859 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
