...
**183 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 46 | | PROPOSED | 183 |
| APPENDAGE | 35 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 10 | |  |  |
...
151 records are grounded in GO; 32 carry minted identifiers. 183 list components, 183 carry causal graphs (997 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
