...
**466 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 193 | | PROPOSED | 466 |
| OTHER | 95 | |  |  |
| APPENDAGE | 42 | |  |  |
| CYTOSKELETON | 40 | |  |  |
| SPORE | 20 | |  |  |
...
400 records are grounded in GO; 66 carry minted identifiers. 382 list components, 465 carry causal graphs (2073 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
