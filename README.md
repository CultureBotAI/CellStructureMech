...
**289 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 130 | | PROPOSED | 289 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
240 records are grounded in GO; 49 carry minted identifiers. 253 list components, 289 carry causal graphs (1310 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
