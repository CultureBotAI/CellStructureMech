...
**274 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 116 | | PROPOSED | 274 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
225 records are grounded in GO; 49 carry minted identifiers. 242 list components, 274 carry causal graphs (1261 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
