...
**232 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 75 | | PROPOSED | 232 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
194 records are grounded in GO; 38 carry minted identifiers. 215 list components, 232 carry causal graphs (1147 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
