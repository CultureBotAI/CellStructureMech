...
**108 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 28 | | PROPOSED | 108 |
...
93 records are grounded in GO; 15 carry minted identifiers. 108 list components, 108 carry causal graphs (655 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
