...
**64 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 64 |
| SECRETION_SYSTEM | 9 | |  |  |
| MEMBRANE_ORGANELLE | 8 | |  |  |
| MICROCOMPARTMENT | 6 | |  |  |
| ENVELOPE | 4 | |  |  |
| OTHER | 3 | |  |  |
| CYTOSKELETON | 2 | |  |  |
...
58 records are grounded in GO; 6 carry minted identifiers. 64 list components, 64 carry causal graphs (443 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
