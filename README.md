...
**113 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 28 | | PROPOSED | 113 |
...
98 records are grounded in GO; 15 carry minted identifiers. 113 list components, 113 carry causal graphs (668 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
