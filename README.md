...
**257 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 100 | | PROPOSED | 257 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
212 records are grounded in GO; 45 carry minted identifiers. 230 list components, 257 carry causal graphs (1212 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
