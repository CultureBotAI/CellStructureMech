...
**491 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 491 |
| OTHER | 98 | |  |  |
| CYTOSKELETON | 58 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 21 | |  |  |
...
425 records are grounded in GO; 66 carry minted identifiers. 395 list components, 490 carry causal graphs (2171 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
