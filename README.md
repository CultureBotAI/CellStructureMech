...
**369 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 174 | | PROPOSED | 369 |
| OTHER | 47 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
315 records are grounded in GO; 54 carry minted identifiers. 305 list components, 369 carry causal graphs (1607 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
