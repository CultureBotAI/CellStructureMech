...
**382 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 382 |
| OTHER | 57 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
328 records are grounded in GO; 54 carry minted identifiers. 316 list components, 382 carry causal graphs (1674 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
