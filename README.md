...
**494 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 494 |
| OTHER | 101 | |  |  |
| CYTOSKELETON | 58 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 21 | |  |  |
...
428 records are grounded in GO; 66 carry minted identifiers. 395 list components, 493 carry causal graphs (2182 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
