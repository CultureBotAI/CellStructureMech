...
**540 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 540 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
...
473 records are grounded in GO; 67 carry minted identifiers. 438 list components, 539 carry causal graphs (2378 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
