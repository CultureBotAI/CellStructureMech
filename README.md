...
**192 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 54 | | PROPOSED | 192 |
| APPENDAGE | 35 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
160 records are grounded in GO; 32 carry minted identifiers. 192 list components, 192 carry causal graphs (1023 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
