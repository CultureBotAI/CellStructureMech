...
**134 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 33 | | PROPOSED | 134 |
...
102 records are grounded in GO; 32 carry minted identifiers. 134 list components, 134 carry causal graphs (748 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
