...
**379 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 379 |
| OTHER | 54 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
325 records are grounded in GO; 54 carry minted identifiers. 313 list components, 379 carry causal graphs (1657 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
