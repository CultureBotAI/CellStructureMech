...
**88 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 88 |
...
78 records are grounded in GO; 10 carry minted identifiers. 88 list components, 88 carry causal graphs (564 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
