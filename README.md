...
**381 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 381 |
| OTHER | 56 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
327 records are grounded in GO; 54 carry minted identifiers. 315 list components, 381 carry causal graphs (1668 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
