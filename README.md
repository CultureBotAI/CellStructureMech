...
**66 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 66 |
| MEMBRANE_ORGANELLE | 10 | |  |  |
| SECRETION_SYSTEM | 9 | |  |  |
| MICROCOMPARTMENT | 6 | |  |  |
| ENVELOPE | 4 | |  |  |
| OTHER | 3 | |  |  |
...
60 records are grounded in GO; 6 carry minted identifiers. 66 list components, 66 carry causal graphs (454 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
