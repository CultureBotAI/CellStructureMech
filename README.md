...
**186 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 48 | | PROPOSED | 186 |
| APPENDAGE | 35 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
154 records are grounded in GO; 32 carry minted identifiers. 186 list components, 186 carry causal graphs (1005 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
