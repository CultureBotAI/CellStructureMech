...
**147 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 34 | | PROPOSED | 147 |
| APPENDAGE | 33 | |  |  |
| OTHER | 19 | |  |  |
| CYTOSKELETON | 17 | |  |  |
| SECRETION_SYSTEM | 10 | |  |  |
...
115 records are grounded in GO; 32 carry minted identifiers. 147 list components, 147 carry causal graphs (814 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
