...
**512 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 512 |
| OTHER | 105 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
...
445 records are grounded in GO; 67 carry minted identifiers. 410 list components, 511 carry causal graphs (2298 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
