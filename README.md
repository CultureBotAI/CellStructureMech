...
**281 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 122 | | PROPOSED | 281 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
232 records are grounded in GO; 49 carry minted identifiers. 245 list components, 281 carry causal graphs (1284 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
