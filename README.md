...
**414 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 414 |
| OTHER | 89 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
360 records are grounded in GO; 54 carry minted identifiers. 339 list components, 414 carry causal graphs (1855 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
