...
**61 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 61 |
| SECRETION_SYSTEM | 9 | |  |  |
...
55 records are grounded in GO; 6 carry minted identifiers. 61 list components, 61 carry causal graphs (424 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
