...
**59 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 21 | | PROPOSED | 59 |
| SECRETION_SYSTEM | 9 | |  |  |
...
53 records are grounded in GO; 6 carry minted identifiers. 59 list components, 59 carry causal graphs (413 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
