...
**45 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| SECRETION_SYSTEM | 9 | | PROPOSED | 45 |
| APPENDAGE | 7 | |  |  |
...
39 records are grounded in GO; 6 carry minted identifiers. 45 list components, 45 carry causal graphs (316 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
