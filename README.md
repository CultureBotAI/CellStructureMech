...
**342 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 159 | | PROPOSED | 342 |
| OTHER | 41 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 29 | |  |  |
| ENERGY_COMPLEX | 12 | |  |  |
...
288 records are grounded in GO; 54 carry minted identifiers. 283 list components, 342 carry causal graphs (1493 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
