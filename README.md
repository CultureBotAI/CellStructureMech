...
**117 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 28 | | PROPOSED | 117 |
...
99 records are grounded in GO; 18 carry minted identifiers. 117 list components, 117 carry causal graphs (683 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
