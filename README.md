...
**438 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 184 | | PROPOSED | 438 |
| OTHER | 95 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 38 | |  |  |
| ENVELOPE | 15 | |  |  |
...
380 records are grounded in GO; 58 carry minted identifiers. 362 list components, 438 carry causal graphs (1961 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
