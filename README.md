...
**361 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 168 | | PROPOSED | 361 |
| OTHER | 45 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
307 records are grounded in GO; 54 carry minted identifiers. 299 list components, 361 carry causal graphs (1566 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
