...
**513 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 513 |
| OTHER | 106 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
...
446 records are grounded in GO; 67 carry minted identifiers. 411 list components, 512 carry causal graphs (2301 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
