...
**265 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 108 | | PROPOSED | 265 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
216 records are grounded in GO; 49 carry minted identifiers. 236 list components, 265 carry causal graphs (1237 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
