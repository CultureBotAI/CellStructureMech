...
**543 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 543 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| RIBONUCLEOPROTEIN | 36 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
| SPORE | 21 | |  |  |
| ENVELOPE | 16 | |  |  |
| SECRETION_SYSTEM | 15 | |  |  |
...
476 records are grounded in GO; 67 carry minted identifiers. 441 list components, 542 carry causal graphs (2387 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
