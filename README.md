...
**574 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 574 |
| OTHER | 112 | |  |  |
| RIBONUCLEOPROTEIN | 63 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
| SPORE | 21 | |  |  |
...
507 records are grounded in GO; 67 carry minted identifiers. 464 list components, 573 carry causal graphs (2458 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
