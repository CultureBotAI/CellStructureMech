...
**201 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 63 | | PROPOSED | 201 |
| APPENDAGE | 35 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
169 records are grounded in GO; 32 carry minted identifiers. 199 list components, 201 carry causal graphs (1050 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
