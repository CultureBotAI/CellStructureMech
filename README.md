...
**488 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 195 | | PROPOSED | 488 |
| OTHER | 97 | |  |  |
| CYTOSKELETON | 58 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 20 | |  |  |
...
422 records are grounded in GO; 66 carry minted identifiers. 394 list components, 487 carry causal graphs (2160 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
