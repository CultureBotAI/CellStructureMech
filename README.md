...
**441 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 187 | | PROPOSED | 441 |
| OTHER | 95 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 38 | |  |  |
| ENVELOPE | 15 | |  |  |
...
383 records are grounded in GO; 58 carry minted identifiers. 363 list components, 441 carry causal graphs (1970 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
