...
**444 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 190 | | PROPOSED | 444 |
| OTHER | 95 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 38 | |  |  |
| ENVELOPE | 15 | |  |  |
...
386 records are grounded in GO; 58 carry minted identifiers. 365 list components, 444 carry causal graphs (1982 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
