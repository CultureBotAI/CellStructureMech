...
**419 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 419 |
| OTHER | 93 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 32 | |  |  |
| ENVELOPE | 14 | |  |  |
...
365 records are grounded in GO; 54 carry minted identifiers. 343 list components, 419 carry causal graphs (1877 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
