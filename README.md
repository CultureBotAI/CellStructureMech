...
**487 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 195 | | PROPOSED | 487 |
| OTHER | 96 | |  |  |
| CYTOSKELETON | 58 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 20 | |  |  |
...
421 records are grounded in GO; 66 carry minted identifiers. 393 list components, 486 carry causal graphs (2157 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
