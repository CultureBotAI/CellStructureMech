...
**581 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 581 |
| OTHER | 113 | |  |  |
...
514 records are grounded in GO; 67 carry minted identifiers. 471 list components, 580 carry causal graphs (2481 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
