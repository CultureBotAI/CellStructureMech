...
**415 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 415 |
| OTHER | 90 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
361 records are grounded in GO; 54 carry minted identifiers. 339 list components, 415 carry causal graphs (1857 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
