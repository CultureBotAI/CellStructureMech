...
**571 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 571 |
| OTHER | 111 | |  |  |
...
504 records are grounded in GO; 67 carry minted identifiers. 463 list components, 570 carry causal graphs (2447 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
