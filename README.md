...
**298 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 139 | | PROPOSED | 298 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
249 records are grounded in GO; 49 carry minted identifiers. 259 list components, 298 carry causal graphs (1335 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
