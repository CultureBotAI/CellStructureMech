...
**44 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| SECRETION_SYSTEM | 9 | | PROPOSED | 44 |
| APPENDAGE | 7 | |  |  |
| MEMBRANE_ORGANELLE | 6 | |  |  |
| MICROCOMPARTMENT | 6 | |  |  |
| ENVELOPE | 4 | |  |  |
| OTHER | 3 | |  |  |
...
38 records are grounded in GO; 6 carry minted identifiers. 44 list components, 44 carry causal graphs (310 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
