...
**74 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 74 |
| MEMBRANE_ORGANELLE | 14 | |  |  |
| SECRETION_SYSTEM | 9 | |  |  |
| MICROCOMPARTMENT | 6 | |  |  |
| CYTOSKELETON | 4 | |  |  |
| ENVELOPE | 4 | |  |  |
...
68 records are grounded in GO; 6 carry minted identifiers. 74 list components, 74 carry causal graphs (510 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
