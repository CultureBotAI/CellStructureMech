...
**72 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 72 |
...
66 records are grounded in GO; 6 carry minted identifiers. 72 list components, 72 carry causal graphs (501 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
