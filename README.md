...
**87 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 87 |
...
77 records are grounded in GO; 10 carry minted identifiers. 87 list components, 87 carry causal graphs (559 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
