...
**314 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 151 | | PROPOSED | 314 |
| APPENDAGE | 38 | |  |  |
| OTHER | 36 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 12 | |  |  |
...
260 records are grounded in GO; 54 carry minted identifiers. 264 list components, 314 carry causal graphs (1386 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
