...
**576 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 576 |
| OTHER | 112 | |  |  |
| RIBONUCLEOPROTEIN | 65 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
| SPORE | 21 | |  |  |
...
509 records are grounded in GO; 67 carry minted identifiers. 466 list components, 575 carry causal graphs (2464 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
