...
**177 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 43 | | PROPOSED | 177 |
| APPENDAGE | 34 | |  |  |
| OTHER | 27 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 10 | |  |  |
...
145 records are grounded in GO; 32 carry minted identifiers. 177 list components, 177 carry causal graphs (976 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
