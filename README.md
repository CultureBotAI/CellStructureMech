...
**221 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 75 | | PROPOSED | 221 |
| APPENDAGE | 36 | |  |  |
| OTHER | 31 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
189 records are grounded in GO; 32 carry minted identifiers. 208 list components, 221 carry causal graphs (1105 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
