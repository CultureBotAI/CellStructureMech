...
**486 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 195 | | PROPOSED | 486 |
| OTHER | 95 | |  |  |
| CYTOSKELETON | 58 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 20 | |  |  |
...
420 records are grounded in GO; 66 carry minted identifiers. 392 list components, 485 carry causal graphs (2153 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
