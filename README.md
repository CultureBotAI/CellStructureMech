...
**228 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 75 | | PROPOSED | 228 |
| APPENDAGE | 36 | |  |  |
| OTHER | 31 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
191 records are grounded in GO; 37 carry minted identifiers. 212 list components, 228 carry causal graphs (1134 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
