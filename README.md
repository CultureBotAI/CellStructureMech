...
**505 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 505 |
| OTHER | 103 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 21 | |  |  |
...
439 records are grounded in GO; 66 carry minted identifiers. 403 list components, 504 carry causal graphs (2250 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
