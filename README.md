...
**521 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 521 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
...
| ENVELOPE | 16 | |  |  |
| SECRETION_SYSTEM | 15 | |  |  |
| RIBONUCLEOPROTEIN | 14 | |  |  |
| INCLUSION | 11 | |  |  |
| MICROCOMPARTMENT | 6 | |  |  |
| NUCLEOID | 5 | |  |  |
| DIVISION_MACHINERY | 2 | |  |  |

454 records are grounded in GO; 67 carry minted identifiers. 419 list components, 520 carry causal graphs (2331 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
