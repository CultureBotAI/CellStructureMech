...
**489 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 195 | | PROPOSED | 489 |
| OTHER | 98 | |  |  |
| CYTOSKELETON | 58 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 20 | |  |  |
...
423 records are grounded in GO; 66 carry minted identifiers. 395 list components, 488 carry causal graphs (2165 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
