...
**356 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 165 | | PROPOSED | 356 |
| OTHER | 44 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENERGY_COMPLEX | 13 | |  |  |
...
302 records are grounded in GO; 54 carry minted identifiers. 294 list components, 356 carry causal graphs (1546 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
