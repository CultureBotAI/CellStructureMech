...
**426 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 178 | | PROPOSED | 426 |
| OTHER | 94 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 35 | |  |  |
| ENVELOPE | 14 | |  |  |
...
370 records are grounded in GO; 56 carry minted identifiers. 350 list components, 426 carry causal graphs (1912 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
