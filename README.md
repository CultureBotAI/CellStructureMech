...
**372 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 372 |
| OTHER | 47 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
318 records are grounded in GO; 54 carry minted identifiers. 306 list components, 372 carry causal graphs (1616 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
