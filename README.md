...
**38 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 6 | | PROPOSED | 38 |
...
36 records are grounded in GO; 2 carry minted identifiers. 38 list components, 38 carry causal graphs (273 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
