...
**115 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 28 | | PROPOSED | 115 |
...
99 records are grounded in GO; 16 carry minted identifiers. 115 list components, 115 carry causal graphs (676 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
