...
**35 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 6 | | PROPOSED | 35 |
| APPENDAGE | 5 | |  |  |
| SECRETION_SYSTEM | 5 | |  |  |
| ENVELOPE | 4 | |  |  |
| MICROCOMPARTMENT | 4 | |  |  |
...
33 records are grounded in GO; 2 carry minted identifiers. 35 list components, 35 carry causal graphs (252 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
