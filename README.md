...
**596 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 596 |
| OTHER | 128 | |  |  |
...
529 records are grounded in GO; 67 carry minted identifiers. 486 list components, 595 carry causal graphs (2587 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
