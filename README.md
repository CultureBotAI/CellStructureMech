...
**534 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 534 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
...
467 records are grounded in GO; 67 carry minted identifiers. 432 list components, 533 carry causal graphs (2362 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
