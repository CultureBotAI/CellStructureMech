...
**293 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 134 | | PROPOSED | 293 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
244 records are grounded in GO; 49 carry minted identifiers. 256 list components, 293 carry causal graphs (1324 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
