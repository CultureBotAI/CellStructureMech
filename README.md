...
**599 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 599 |
| OTHER | 131 | |  |  |
...
532 records are grounded in GO; 67 carry minted identifiers. 489 list components, 598 carry causal graphs (2612 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
