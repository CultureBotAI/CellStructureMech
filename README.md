...
**295 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 136 | | PROPOSED | 295 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
246 records are grounded in GO; 49 carry minted identifiers. 257 list components, 295 carry causal graphs (1329 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
