...
**413 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 413 |
| OTHER | 88 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
359 records are grounded in GO; 54 carry minted identifiers. 338 list components, 413 carry causal graphs (1848 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
