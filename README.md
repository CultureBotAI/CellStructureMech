...
**276 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 117 | | PROPOSED | 276 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
227 records are grounded in GO; 49 carry minted identifiers. 242 list components, 276 carry causal graphs (1266 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
