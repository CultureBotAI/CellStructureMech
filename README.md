...
**506 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 506 |
| OTHER | 103 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 21 | |  |  |
...
440 records are grounded in GO; 66 carry minted identifiers. 404 list components, 505 carry causal graphs (2257 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
