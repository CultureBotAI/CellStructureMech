...
**156 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 36 | | PROPOSED | 156 |
| APPENDAGE | 34 | |  |  |
| OTHER | 22 | |  |  |
| CYTOSKELETON | 18 | |  |  |
| ENVELOPE | 10 | |  |  |
...
124 records are grounded in GO; 32 carry minted identifiers. 156 list components, 156 carry causal graphs (868 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
