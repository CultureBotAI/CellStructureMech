...
**344 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 161 | | PROPOSED | 344 |
| OTHER | 41 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 29 | |  |  |
| ENERGY_COMPLEX | 12 | |  |  |
...
290 records are grounded in GO; 54 carry minted identifiers. 284 list components, 344 carry causal graphs (1504 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
