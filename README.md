...
**208 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 68 | | PROPOSED | 208 |
| APPENDAGE | 36 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
176 records are grounded in GO; 32 carry minted identifiers. 203 list components, 208 carry causal graphs (1065 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
