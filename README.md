...
**573 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 573 |
| OTHER | 112 | |  |  |
| RIBONUCLEOPROTEIN | 62 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
| SPORE | 21 | |  |  |
...
506 records are grounded in GO; 67 carry minted identifiers. 463 list components, 572 carry causal graphs (2454 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
