...
**366 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 171 | | PROPOSED | 366 |
| OTHER | 47 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
312 records are grounded in GO; 54 carry minted identifiers. 304 list components, 366 carry causal graphs (1596 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
