...
**601 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 601 |
| OTHER | 133 | |  |  |
...
534 records are grounded in GO; 67 carry minted identifiers. 491 list components, 600 carry causal graphs (2625 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
