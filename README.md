...
**525 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 525 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
| SPORE | 21 | |  |  |
| RIBONUCLEOPROTEIN | 18 | |  |  |
| ENVELOPE | 16 | |  |  |
| SECRETION_SYSTEM | 15 | |  |  |
| INCLUSION | 11 | |  |  |
| MICROCOMPARTMENT | 6 | |  |  |
...
458 records are grounded in GO; 67 carry minted identifiers. 423 list components, 524 carry causal graphs (2339 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
