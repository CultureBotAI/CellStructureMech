...
**270 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 112 | | PROPOSED | 270 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
221 records are grounded in GO; 49 carry minted identifiers. 239 list components, 270 carry causal graphs (1247 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
