...
**288 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 129 | | PROPOSED | 288 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
239 records are grounded in GO; 49 carry minted identifiers. 252 list components, 288 carry causal graphs (1307 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
