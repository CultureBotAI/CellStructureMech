...
**580 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 580 |
| OTHER | 112 | |  |  |
...
513 records are grounded in GO; 67 carry minted identifiers. 470 list components, 579 carry causal graphs (2476 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
