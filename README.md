...
**343 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 160 | | PROPOSED | 343 |
| OTHER | 41 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 29 | |  |  |
| ENERGY_COMPLEX | 12 | |  |  |
...
289 records are grounded in GO; 54 carry minted identifiers. 284 list components, 343 carry causal graphs (1500 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
