...
**380 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 380 |
| OTHER | 55 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
326 records are grounded in GO; 54 carry minted identifiers. 314 list components, 380 carry causal graphs (1661 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
