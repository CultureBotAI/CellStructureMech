...
**449 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 191 | | PROPOSED | 449 |
| OTHER | 95 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 38 | |  |  |
| ENVELOPE | 16 | |  |  |
...
391 records are grounded in GO; 58 carry minted identifiers. 365 list components, 448 carry causal graphs (1991 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
