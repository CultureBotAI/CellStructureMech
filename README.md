...
**238 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 81 | | PROPOSED | 238 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
199 records are grounded in GO; 39 carry minted identifiers. 219 list components, 238 carry causal graphs (1165 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
