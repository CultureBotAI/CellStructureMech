...
**593 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 593 |
| OTHER | 125 | |  |  |
...
526 records are grounded in GO; 67 carry minted identifiers. 483 list components, 592 carry causal graphs (2547 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
