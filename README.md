...
**317 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 154 | | PROPOSED | 317 |
| APPENDAGE | 38 | |  |  |
| OTHER | 36 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 12 | |  |  |
...
263 records are grounded in GO; 54 carry minted identifiers. 265 list components, 317 carry causal graphs (1399 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
