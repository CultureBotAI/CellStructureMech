...
**144 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 33 | | PROPOSED | 144 |
...
112 records are grounded in GO; 32 carry minted identifiers. 144 list components, 144 carry causal graphs (798 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
