...
**261 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 104 | | PROPOSED | 261 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
212 records are grounded in GO; 49 carry minted identifiers. 232 list components, 261 carry causal graphs (1223 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
