...
**326 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 159 | | PROPOSED | 326 |
| APPENDAGE | 38 | |  |  |
| OTHER | 36 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENERGY_COMPLEX | 12 | |  |  |
...
272 records are grounded in GO; 54 carry minted identifiers. 269 list components, 326 carry causal graphs (1443 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
