...
**519 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 519 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
...
| ENVELOPE | 16 | |  |  |
| SECRETION_SYSTEM | 15 | |  |  |
| RIBONUCLEOPROTEIN | 12 | |  |  |
| INCLUSION | 11 | |  |  |
| MICROCOMPARTMENT | 6 | |  |  |
| NUCLEOID | 5 | |  |  |
| DIVISION_MACHINERY | 2 | |  |  |

452 records are grounded in GO; 67 carry minted identifiers. 417 list components, 518 carry causal graphs (2327 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
