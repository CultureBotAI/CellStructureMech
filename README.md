...
**194 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 56 | | PROPOSED | 194 |
| APPENDAGE | 35 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
162 records are grounded in GO; 32 carry minted identifiers. 193 list components, 194 carry causal graphs (1028 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
