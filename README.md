...
**359 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 167 | | PROPOSED | 359 |
| OTHER | 44 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
305 records are grounded in GO; 54 carry minted identifiers. 297 list components, 359 carry causal graphs (1557 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
