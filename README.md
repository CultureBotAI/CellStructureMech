...
**459 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 192 | | PROPOSED | 459 |
| OTHER | 95 | |  |  |
| APPENDAGE | 42 | |  |  |
| CYTOSKELETON | 38 | |  |  |
| SPORE | 20 | |  |  |
...
398 records are grounded in GO; 61 carry minted identifiers. 375 list components, 458 carry causal graphs (2041 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
