...
**355 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 165 | | PROPOSED | 355 |
| OTHER | 43 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENERGY_COMPLEX | 13 | |  |  |
...
301 records are grounded in GO; 54 carry minted identifiers. 293 list components, 355 carry causal graphs (1542 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
