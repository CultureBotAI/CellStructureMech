...
**328 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 159 | | PROPOSED | 328 |
| APPENDAGE | 38 | |  |  |
| OTHER | 38 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENERGY_COMPLEX | 12 | |  |  |
...
274 records are grounded in GO; 54 carry minted identifiers. 271 list components, 328 carry causal graphs (1453 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
