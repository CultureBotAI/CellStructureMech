...
**125 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 28 | | PROPOSED | 125 |
...
100 records are grounded in GO; 25 carry minted identifiers. 125 list components, 125 carry causal graphs (711 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
