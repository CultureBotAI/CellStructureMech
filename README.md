...
**206 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 67 | | PROPOSED | 206 |
| APPENDAGE | 36 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
174 records are grounded in GO; 32 carry minted identifiers. 202 list components, 206 carry causal graphs (1061 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
