...
**185 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 48 | | PROPOSED | 185 |
| APPENDAGE | 35 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 10 | |  |  |
...
153 records are grounded in GO; 32 carry minted identifiers. 185 list components, 185 carry causal graphs (1003 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
