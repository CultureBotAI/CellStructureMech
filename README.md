...
**95 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 25 | | PROPOSED | 95 |
...
84 records are grounded in GO; 11 carry minted identifiers. 95 list components, 95 carry causal graphs (593 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
