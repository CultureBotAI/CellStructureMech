...
**224 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 75 | | PROPOSED | 224 |
| APPENDAGE | 36 | |  |  |
| OTHER | 31 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
189 records are grounded in GO; 35 carry minted identifiers. 208 list components, 224 carry causal graphs (1117 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
