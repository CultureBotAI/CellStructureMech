...
**347 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 162 | | PROPOSED | 347 |
| OTHER | 43 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 29 | |  |  |
| ENERGY_COMPLEX | 12 | |  |  |
...
293 records are grounded in GO; 54 carry minted identifiers. 286 list components, 347 carry causal graphs (1513 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
