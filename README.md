...
**371 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 176 | | PROPOSED | 371 |
| OTHER | 47 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
317 records are grounded in GO; 54 carry minted identifiers. 306 list components, 371 carry causal graphs (1614 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
