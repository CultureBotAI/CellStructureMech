...
**305 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 145 | | PROPOSED | 305 |
| APPENDAGE | 38 | |  |  |
| OTHER | 34 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
252 records are grounded in GO; 53 carry minted identifiers. 260 list components, 305 carry causal graphs (1351 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
