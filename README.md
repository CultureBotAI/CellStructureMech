...
**103 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 28 | | PROPOSED | 103 |
...
88 records are grounded in GO; 15 carry minted identifiers. 103 list components, 103 carry causal graphs (632 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
