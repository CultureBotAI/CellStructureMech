...
**410 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 410 |
| OTHER | 85 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
356 records are grounded in GO; 54 carry minted identifiers. 337 list components, 410 carry causal graphs (1835 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
