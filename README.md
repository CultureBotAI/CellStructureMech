...
**145 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 33 | | PROPOSED | 145 |
...
113 records are grounded in GO; 32 carry minted identifiers. 145 list components, 145 carry causal graphs (802 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
