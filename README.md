...
**285 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 126 | | PROPOSED | 285 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
236 records are grounded in GO; 49 carry minted identifiers. 249 list components, 285 carry causal graphs (1297 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
