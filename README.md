...
**76 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 76 |
...
70 records are grounded in GO; 6 carry minted identifiers. 76 list components, 76 carry causal graphs (520 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
