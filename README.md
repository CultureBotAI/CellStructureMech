...
**312 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 149 | | PROPOSED | 312 |
| APPENDAGE | 38 | |  |  |
| OTHER | 36 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 12 | |  |  |
...
258 records are grounded in GO; 54 carry minted identifiers. 263 list components, 312 carry causal graphs (1376 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
