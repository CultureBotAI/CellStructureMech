...
**284 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 125 | | PROPOSED | 284 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
235 records are grounded in GO; 49 carry minted identifiers. 248 list components, 284 carry causal graphs (1294 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
