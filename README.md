...
**26 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 5 | | PROPOSED | 26 |
| ENVELOPE | 4 | |  |  |
| APPENDAGE | 3 | |  |  |
...
24 records are grounded in GO; 2 carry minted identifiers. 26 list components, 26 carry causal graphs (197 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
