...
**216 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 75 | | PROPOSED | 216 |
| APPENDAGE | 36 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
184 records are grounded in GO; 32 carry minted identifiers. 208 list components, 216 carry causal graphs (1086 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
