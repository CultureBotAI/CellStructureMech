...
**346 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 162 | | PROPOSED | 346 |
| OTHER | 42 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 29 | |  |  |
| ENERGY_COMPLEX | 12 | |  |  |
...
292 records are grounded in GO; 54 carry minted identifiers. 286 list components, 346 carry causal graphs (1513 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
