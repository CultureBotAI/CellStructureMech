...
**263 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 106 | | PROPOSED | 263 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
214 records are grounded in GO; 49 carry minted identifiers. 234 list components, 263 carry causal graphs (1231 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
