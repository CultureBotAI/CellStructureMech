...
**231 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 75 | | PROPOSED | 231 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
193 records are grounded in GO; 38 carry minted identifiers. 214 list components, 231 carry causal graphs (1144 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
