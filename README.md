...
**358 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 167 | | PROPOSED | 358 |
| OTHER | 44 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENERGY_COMPLEX | 13 | |  |  |
...
304 records are grounded in GO; 54 carry minted identifiers. 296 list components, 358 carry causal graphs (1554 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
