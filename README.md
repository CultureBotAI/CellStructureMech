...
**592 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 592 |
| OTHER | 124 | |  |  |
...
525 records are grounded in GO; 67 carry minted identifiers. 482 list components, 591 carry causal graphs (2539 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
