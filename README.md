...
**193 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 55 | | PROPOSED | 193 |
| APPENDAGE | 35 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
161 records are grounded in GO; 32 carry minted identifiers. 192 list components, 193 carry causal graphs (1024 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
