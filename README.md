...
**37 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 6 | | PROPOSED | 37 |
...
35 records are grounded in GO; 2 carry minted identifiers. 37 list components, 37 carry causal graphs (267 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
