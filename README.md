...
**230 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 75 | | PROPOSED | 230 |
| APPENDAGE | 37 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
193 records are grounded in GO; 37 carry minted identifiers. 213 list components, 230 carry causal graphs (1140 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
