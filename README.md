...
**203 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 65 | | PROPOSED | 203 |
| APPENDAGE | 35 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
171 records are grounded in GO; 32 carry minted identifiers. 200 list components, 203 carry causal graphs (1054 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
