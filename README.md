...
**579 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 579 |
| OTHER | 112 | |  |  |
| RIBONUCLEOPROTEIN | 68 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
| SPORE | 21 | |  |  |
...
512 records are grounded in GO; 67 carry minted identifiers. 469 list components, 578 carry causal graphs (2473 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
