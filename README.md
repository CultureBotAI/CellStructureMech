...
**309 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 146 | | PROPOSED | 309 |
| APPENDAGE | 38 | |  |  |
| OTHER | 36 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 12 | |  |  |
...
256 records are grounded in GO; 53 carry minted identifiers. 262 list components, 309 carry causal graphs (1362 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
