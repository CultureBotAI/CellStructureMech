...
**266 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 109 | | PROPOSED | 266 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
217 records are grounded in GO; 49 carry minted identifiers. 236 list components, 266 carry causal graphs (1240 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
