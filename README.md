...
**510 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 510 |
| OTHER | 103 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
...
443 records are grounded in GO; 67 carry minted identifiers. 408 list components, 509 carry causal graphs (2286 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
