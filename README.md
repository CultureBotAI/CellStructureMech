...
**296 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 137 | | PROPOSED | 296 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
247 records are grounded in GO; 49 carry minted identifiers. 258 list components, 296 carry causal graphs (1331 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
