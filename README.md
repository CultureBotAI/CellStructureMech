...
**476 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 193 | | PROPOSED | 476 |
| OTHER | 95 | |  |  |
| CYTOSKELETON | 50 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 20 | |  |  |
...
410 records are grounded in GO; 66 carry minted identifiers. 391 list components, 475 carry causal graphs (2115 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
