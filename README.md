...
**373 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 373 |
| OTHER | 48 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
319 records are grounded in GO; 54 carry minted identifiers. 307 list components, 373 carry causal graphs (1621 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
