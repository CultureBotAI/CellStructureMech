...
**168 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 40 | | PROPOSED | 168 |
| APPENDAGE | 34 | |  |  |
| OTHER | 26 | |  |  |
| CYTOSKELETON | 19 | |  |  |
| ENVELOPE | 10 | |  |  |
...
136 records are grounded in GO; 32 carry minted identifiers. 168 list components, 168 carry causal graphs (944 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
