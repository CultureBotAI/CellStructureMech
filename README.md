...
**180 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 45 | | PROPOSED | 180 |
| APPENDAGE | 35 | |  |  |
| OTHER | 27 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 10 | |  |  |
...
148 records are grounded in GO; 32 carry minted identifiers. 180 list components, 180 carry causal graphs (988 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
