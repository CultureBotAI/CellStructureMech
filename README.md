...
**65 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 65 |
| MEMBRANE_ORGANELLE | 9 | |  |  |
| SECRETION_SYSTEM | 9 | |  |  |
| MICROCOMPARTMENT | 6 | |  |  |
| ENVELOPE | 4 | |  |  |
| OTHER | 3 | |  |  |
...
59 records are grounded in GO; 6 carry minted identifiers. 65 list components, 65 carry causal graphs (449 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
