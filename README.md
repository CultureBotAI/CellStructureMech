...
**279 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 120 | | PROPOSED | 279 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
230 records are grounded in GO; 49 carry minted identifiers. 243 list components, 279 carry causal graphs (1278 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
