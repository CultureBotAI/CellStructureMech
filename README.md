...
**527 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 527 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
| SPORE | 21 | |  |  |
| RIBONUCLEOPROTEIN | 20 | |  |  |
| ENVELOPE | 16 | |  |  |
| SECRETION_SYSTEM | 15 | |  |  |
| INCLUSION | 11 | |  |  |
| MICROCOMPARTMENT | 6 | |  |  |
...
460 records are grounded in GO; 67 carry minted identifiers. 425 list components, 526 carry causal graphs (2347 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
