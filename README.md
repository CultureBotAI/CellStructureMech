...
**91 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 91 |
...
81 records are grounded in GO; 10 carry minted identifiers. 91 list components, 91 carry causal graphs (572 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
