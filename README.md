...
**398 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 398 |
| OTHER | 73 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
344 records are grounded in GO; 54 carry minted identifiers. 332 list components, 398 carry causal graphs (1794 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
