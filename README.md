...
**360 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 167 | | PROPOSED | 360 |
| OTHER | 45 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
306 records are grounded in GO; 54 carry minted identifiers. 298 list components, 360 carry causal graphs (1560 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
