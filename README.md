...
**427 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 178 | | PROPOSED | 427 |
| OTHER | 94 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 36 | |  |  |
| ENVELOPE | 14 | |  |  |
...
371 records are grounded in GO; 56 carry minted identifiers. 351 list components, 427 carry causal graphs (1915 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
