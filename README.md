...
**320 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 157 | | PROPOSED | 320 |
| APPENDAGE | 38 | |  |  |
| OTHER | 36 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 12 | |  |  |
...
266 records are grounded in GO; 54 carry minted identifiers. 267 list components, 320 carry causal graphs (1419 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
