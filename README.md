...
**243 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 86 | | PROPOSED | 243 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
204 records are grounded in GO; 39 carry minted identifiers. 221 list components, 243 carry causal graphs (1177 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
