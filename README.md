...
**586 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 586 |
| OTHER | 118 | |  |  |
...
519 records are grounded in GO; 67 carry minted identifiers. 476 list components, 585 carry causal graphs (2517 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
