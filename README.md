...
**47 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 9 | | PROPOSED | 47 |
| SECRETION_SYSTEM | 9 | |  |  |
...
41 records are grounded in GO; 6 carry minted identifiers. 47 list components, 47 carry causal graphs (331 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
