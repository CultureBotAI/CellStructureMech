...
**402 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 402 |
| OTHER | 77 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
348 records are grounded in GO; 54 carry minted identifiers. 336 list components, 402 carry causal graphs (1810 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
