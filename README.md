...
**337 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 159 | | PROPOSED | 337 |
| APPENDAGE | 40 | |  |  |
| OTHER | 40 | |  |  |
| CYTOSKELETON | 28 | |  |  |
| ENERGY_COMPLEX | 12 | |  |  |
...
283 records are grounded in GO; 54 carry minted identifiers. 279 list components, 337 carry causal graphs (1481 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
