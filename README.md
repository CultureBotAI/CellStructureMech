...
**391 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 391 |
| OTHER | 66 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
337 records are grounded in GO; 54 carry minted identifiers. 325 list components, 391 carry causal graphs (1744 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
