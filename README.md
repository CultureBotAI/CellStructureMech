...
**138 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 33 | | PROPOSED | 138 |
| MEMBRANE_ORGANELLE | 29 | |  |  |
| OTHER | 18 | |  |  |
| CYTOSKELETON | 17 | |  |  |
| SECRETION_SYSTEM | 10 | |  |  |
| ENVELOPE | 8 | |  |  |
...
106 records are grounded in GO; 32 carry minted identifiers. 138 list components, 138 carry causal graphs (767 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
