...
**272 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 114 | | PROPOSED | 272 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
223 records are grounded in GO; 49 carry minted identifiers. 240 list components, 272 carry causal graphs (1251 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
