...
**517 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 517 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
...
| SECRETION_SYSTEM | 15 | |  |  |
| INCLUSION | 11 | |  |  |
| RIBONUCLEOPROTEIN | 10 | |  |  |
| MICROCOMPARTMENT | 6 | |  |  |
| NUCLEOID | 5 | |  |  |
| DIVISION_MACHINERY | 2 | |  |  |

450 records are grounded in GO; 67 carry minted identifiers. 415 list components, 516 carry causal graphs (2321 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
