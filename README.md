...
**79 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 79 |
...
70 records are grounded in GO; 9 carry minted identifiers. 79 list components, 79 carry causal graphs (529 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
