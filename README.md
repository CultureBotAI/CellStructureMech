...
**475 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 193 | | PROPOSED | 475 |
| OTHER | 95 | |  |  |
| CYTOSKELETON | 49 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 20 | |  |  |
...
409 records are grounded in GO; 66 carry minted identifiers. 390 list components, 474 carry causal graphs (2111 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
