...
**434 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 181 | | PROPOSED | 434 |
| OTHER | 95 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 38 | |  |  |
| ENVELOPE | 14 | |  |  |
...
376 records are grounded in GO; 58 carry minted identifiers. 358 list components, 434 carry causal graphs (1939 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
