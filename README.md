...
**129 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 30 | | PROPOSED | 129 |
...
101 records are grounded in GO; 28 carry minted identifiers. 129 list components, 129 carry causal graphs (729 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
