...
**302 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 143 | | PROPOSED | 302 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
249 records are grounded in GO; 53 carry minted identifiers. 259 list components, 302 carry causal graphs (1343 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
