...
**584 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 584 |
| OTHER | 116 | |  |  |
...
517 records are grounded in GO; 67 carry minted identifiers. 474 list components, 583 carry causal graphs (2499 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
