...
**119 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 28 | | PROPOSED | 119 |
...
99 records are grounded in GO; 20 carry minted identifiers. 119 list components, 119 carry causal graphs (690 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
