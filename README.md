...
**507 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 507 |
| OTHER | 103 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 22 | |  |  |
...
441 records are grounded in GO; 66 carry minted identifiers. 405 list components, 506 carry causal graphs (2264 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
