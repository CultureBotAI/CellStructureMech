...
**330 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 159 | | PROPOSED | 330 |
| OTHER | 40 | |  |  |
| APPENDAGE | 38 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENERGY_COMPLEX | 12 | |  |  |
...
276 records are grounded in GO; 54 carry minted identifiers. 273 list components, 330 carry causal graphs (1460 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
