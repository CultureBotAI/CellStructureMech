...
**271 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 113 | | PROPOSED | 271 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
222 records are grounded in GO; 49 carry minted identifiers. 239 list components, 271 carry causal graphs (1249 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
