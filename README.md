...
**222 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 75 | | PROPOSED | 222 |
| APPENDAGE | 36 | |  |  |
| OTHER | 31 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
189 records are grounded in GO; 33 carry minted identifiers. 208 list components, 222 carry causal graphs (1108 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
