...
**133 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 33 | | PROPOSED | 133 |
...
101 records are grounded in GO; 32 carry minted identifiers. 133 list components, 133 carry causal graphs (744 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
