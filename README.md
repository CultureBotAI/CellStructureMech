...
**42 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| SECRETION_SYSTEM | 9 | | PROPOSED | 42 |
| APPENDAGE | 6 | |  |  |
...
37 records are grounded in GO; 5 carry minted identifiers. 42 list components, 42 carry causal graphs (298 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
