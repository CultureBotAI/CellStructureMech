...
**301 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 142 | | PROPOSED | 301 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
249 records are grounded in GO; 52 carry minted identifiers. 259 list components, 301 carry causal graphs (1341 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
