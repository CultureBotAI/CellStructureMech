...
**294 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 135 | | PROPOSED | 294 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
245 records are grounded in GO; 49 carry minted identifiers. 256 list components, 294 carry causal graphs (1327 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
