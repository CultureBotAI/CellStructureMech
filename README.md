...
**542 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 542 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| RIBONUCLEOPROTEIN | 35 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
| SPORE | 21 | |  |  |
| ENVELOPE | 16 | |  |  |
| SECRETION_SYSTEM | 15 | |  |  |
...
475 records are grounded in GO; 67 carry minted identifiers. 440 list components, 541 carry causal graphs (2384 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
