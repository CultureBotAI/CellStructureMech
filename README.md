...
**202 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 64 | | PROPOSED | 202 |
| APPENDAGE | 35 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
170 records are grounded in GO; 32 carry minted identifiers. 199 list components, 202 carry causal graphs (1052 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
