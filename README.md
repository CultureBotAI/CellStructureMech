...
**348 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 163 | | PROPOSED | 348 |
| OTHER | 43 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 29 | |  |  |
| ENERGY_COMPLEX | 12 | |  |  |
...
294 records are grounded in GO; 54 carry minted identifiers. 286 list components, 348 carry causal graphs (1517 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
