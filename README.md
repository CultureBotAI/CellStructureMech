...
**235 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 78 | | PROPOSED | 235 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
196 records are grounded in GO; 39 carry minted identifiers. 218 list components, 235 carry causal graphs (1158 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
