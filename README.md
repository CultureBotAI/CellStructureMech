...
**71 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 71 |
| MEMBRANE_ORGANELLE | 13 | |  |  |
| SECRETION_SYSTEM | 9 | |  |  |
| MICROCOMPARTMENT | 6 | |  |  |
| CYTOSKELETON | 4 | |  |  |
| ENVELOPE | 4 | |  |  |
...
65 records are grounded in GO; 6 carry minted identifiers. 71 list components, 71 carry causal graphs (493 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
