...
**52 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 14 | | PROPOSED | 52 |
| SECRETION_SYSTEM | 9 | |  |  |
...
46 records are grounded in GO; 6 carry minted identifiers. 52 list components, 52 carry causal graphs (363 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
