...
**376 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 376 |
| OTHER | 51 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
322 records are grounded in GO; 54 carry minted identifiers. 310 list components, 376 carry causal graphs (1638 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
