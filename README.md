...
**532 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 532 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
| RIBONUCLEOPROTEIN | 25 | |  |  |
| SPORE | 21 | |  |  |
| ENVELOPE | 16 | |  |  |
| SECRETION_SYSTEM | 15 | |  |  |
| INCLUSION | 11 | |  |  |
...
465 records are grounded in GO; 67 carry minted identifiers. 430 list components, 531 carry causal graphs (2358 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
