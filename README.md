...
**318 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 155 | | PROPOSED | 318 |
| APPENDAGE | 38 | |  |  |
| OTHER | 36 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 12 | |  |  |
...
264 records are grounded in GO; 54 carry minted identifiers. 266 list components, 318 carry causal graphs (1407 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
