...
**604 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 604 |
| OTHER | 136 | |  |  |
...
537 records are grounded in GO; 67 carry minted identifiers. 494 list components, 603 carry causal graphs (2633 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
