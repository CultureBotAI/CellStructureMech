...
**189 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 51 | | PROPOSED | 189 |
| APPENDAGE | 35 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
157 records are grounded in GO; 32 carry minted identifiers. 189 list components, 189 carry causal graphs (1016 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
