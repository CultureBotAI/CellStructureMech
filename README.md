...
**291 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 132 | | PROPOSED | 291 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
242 records are grounded in GO; 49 carry minted identifiers. 254 list components, 291 carry causal graphs (1318 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
