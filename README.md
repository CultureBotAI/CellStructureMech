...
**478 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 193 | | PROPOSED | 478 |
| OTHER | 95 | |  |  |
| CYTOSKELETON | 52 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 20 | |  |  |
...
412 records are grounded in GO; 66 carry minted identifiers. 390 list components, 477 carry causal graphs (2122 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
