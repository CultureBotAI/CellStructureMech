...
**36 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 6 | | PROPOSED | 36 |
| APPENDAGE | 5 | |  |  |
| SECRETION_SYSTEM | 5 | |  |  |
| ENVELOPE | 4 | |  |  |
| MICROCOMPARTMENT | 4 | |  |  |
...
34 records are grounded in GO; 2 carry minted identifiers. 36 list components, 36 carry causal graphs (259 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
