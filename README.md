...
**99 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 28 | | PROPOSED | 99 |
...
84 records are grounded in GO; 15 carry minted identifiers. 99 list components, 99 carry causal graphs (614 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
