...
**245 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 88 | | PROPOSED | 245 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
206 records are grounded in GO; 39 carry minted identifiers. 223 list components, 245 carry causal graphs (1183 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
