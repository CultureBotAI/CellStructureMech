...
**433 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 180 | | PROPOSED | 433 |
| OTHER | 95 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 38 | |  |  |
| ENVELOPE | 14 | |  |  |
...
375 records are grounded in GO; 58 carry minted identifiers. 357 list components, 433 carry causal graphs (1935 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
