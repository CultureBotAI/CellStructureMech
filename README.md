...
**123 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 28 | | PROPOSED | 123 |
...
99 records are grounded in GO; 24 carry minted identifiers. 123 list components, 123 carry causal graphs (701 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
