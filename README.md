...
**511 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 511 |
| OTHER | 104 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
...
444 records are grounded in GO; 67 carry minted identifiers. 409 list components, 510 carry causal graphs (2293 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
