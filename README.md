...
**425 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 178 | | PROPOSED | 425 |
| OTHER | 94 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 34 | |  |  |
| ENVELOPE | 14 | |  |  |
...
370 records are grounded in GO; 55 carry minted identifiers. 349 list components, 425 carry causal graphs (1907 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
