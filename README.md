...
**515 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 515 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
...
448 records are grounded in GO; 67 carry minted identifiers. 413 list components, 514 carry causal graphs (2311 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
