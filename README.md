...
**58 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 20 | | PROPOSED | 58 |
| SECRETION_SYSTEM | 9 | |  |  |
...
52 records are grounded in GO; 6 carry minted identifiers. 58 list components, 58 carry causal graphs (405 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
