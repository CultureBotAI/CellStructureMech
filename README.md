...
**151 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 34 | | PROPOSED | 151 |
| MEMBRANE_ORGANELLE | 34 | |  |  |
| OTHER | 21 | |  |  |
| CYTOSKELETON | 18 | |  |  |
| SECRETION_SYSTEM | 10 | |  |  |
| ENVELOPE | 8 | |  |  |
...
119 records are grounded in GO; 32 carry minted identifiers. 151 list components, 151 carry causal graphs (837 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
