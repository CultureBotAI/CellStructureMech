...
**214 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 73 | | PROPOSED | 214 |
| APPENDAGE | 36 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
182 records are grounded in GO; 32 carry minted identifiers. 207 list components, 214 carry causal graphs (1081 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
