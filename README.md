...
**522 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 522 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
...
455 records are grounded in GO; 67 carry minted identifiers. 420 list components, 521 carry causal graphs (2333 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
