...
**570 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 570 |
| OTHER | 110 | |  |  |
...
503 records are grounded in GO; 67 carry minted identifiers. 463 list components, 569 carry causal graphs (2445 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
