...
**471 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 193 | | PROPOSED | 471 |
| OTHER | 95 | |  |  |
| CYTOSKELETON | 45 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 20 | |  |  |
...
405 records are grounded in GO; 66 carry minted identifiers. 386 list components, 470 carry causal graphs (2095 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
