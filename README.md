...
**93 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 93 |
...
83 records are grounded in GO; 10 carry minted identifiers. 93 list components, 93 carry causal graphs (576 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
