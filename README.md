...
**269 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 111 | | PROPOSED | 269 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
220 records are grounded in GO; 49 carry minted identifiers. 238 list components, 269 carry causal graphs (1245 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
