...
**191 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 53 | | PROPOSED | 191 |
| APPENDAGE | 35 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
159 records are grounded in GO; 32 carry minted identifiers. 191 list components, 191 carry causal graphs (1020 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
