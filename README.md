...
**149 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 34 | | PROPOSED | 149 |
| APPENDAGE | 33 | |  |  |
| OTHER | 20 | |  |  |
| CYTOSKELETON | 18 | |  |  |
| SECRETION_SYSTEM | 10 | |  |  |
...
117 records are grounded in GO; 32 carry minted identifiers. 149 list components, 149 carry causal graphs (824 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
