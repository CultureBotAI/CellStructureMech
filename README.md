...
**560 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 560 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| RIBONUCLEOPROTEIN | 53 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
| SPORE | 21 | |  |  |
| ENVELOPE | 16 | |  |  |
...
493 records are grounded in GO; 67 carry minted identifiers. 458 list components, 559 carry causal graphs (2419 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
