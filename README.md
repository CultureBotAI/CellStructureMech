...
**280 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 121 | | PROPOSED | 280 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
231 records are grounded in GO; 49 carry minted identifiers. 244 list components, 280 carry causal graphs (1281 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
