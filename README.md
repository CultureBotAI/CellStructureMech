...
**329 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 159 | | PROPOSED | 329 |
| OTHER | 39 | |  |  |
| APPENDAGE | 38 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENERGY_COMPLEX | 12 | |  |  |
...
275 records are grounded in GO; 54 carry minted identifiers. 272 list components, 329 carry causal graphs (1456 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
