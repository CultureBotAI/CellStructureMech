...
**226 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 75 | | PROPOSED | 226 |
| APPENDAGE | 36 | |  |  |
| OTHER | 31 | |  |  |
| CYTOSKELETON | 21 | |  |  |
| ENVELOPE | 11 | |  |  |
...
189 records are grounded in GO; 37 carry minted identifiers. 210 list components, 226 carry causal graphs (1125 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
