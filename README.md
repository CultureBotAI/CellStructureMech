...
**43 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| SECRETION_SYSTEM | 9 | | PROPOSED | 43 |
| APPENDAGE | 6 | |  |  |
...
37 records are grounded in GO; 6 carry minted identifiers. 43 list components, 43 carry causal graphs (303 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
