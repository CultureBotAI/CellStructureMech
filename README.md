...
**485 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 195 | | PROPOSED | 485 |
| OTHER | 95 | |  |  |
| CYTOSKELETON | 57 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 20 | |  |  |
...
419 records are grounded in GO; 66 carry minted identifiers. 391 list components, 484 carry causal graphs (2149 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
