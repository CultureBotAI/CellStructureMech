...
**496 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 496 |
| OTHER | 101 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 21 | |  |  |
...
430 records are grounded in GO; 66 carry minted identifiers. 395 list components, 495 carry causal graphs (2196 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
