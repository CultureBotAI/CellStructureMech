...
**597 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 597 |
| OTHER | 129 | |  |  |
...
530 records are grounded in GO; 67 carry minted identifiers. 487 list components, 596 carry causal graphs (2593 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
