...
**135 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 33 | | PROPOSED | 135 |
| MEMBRANE_ORGANELLE | 26 | |  |  |
| OTHER | 18 | |  |  |
| CYTOSKELETON | 17 | |  |  |
| SECRETION_SYSTEM | 10 | |  |  |
| ENVELOPE | 8 | |  |  |
...
103 records are grounded in GO; 32 carry minted identifiers. 135 list components, 135 carry causal graphs (752 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
