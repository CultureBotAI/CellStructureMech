...
**374 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 374 |
| OTHER | 49 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
320 records are grounded in GO; 54 carry minted identifiers. 308 list components, 374 carry causal graphs (1626 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
