...
**547 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 547 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
...
480 records are grounded in GO; 67 carry minted identifiers. 445 list components, 546 carry causal graphs (2391 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
