...
**306 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 145 | | PROPOSED | 306 |
| APPENDAGE | 38 | |  |  |
| OTHER | 34 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 12 | |  |  |
...
253 records are grounded in GO; 53 carry minted identifiers. 261 list components, 306 carry causal graphs (1353 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
