...
**457 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 192 | | PROPOSED | 457 |
| OTHER | 95 | |  |  |
| APPENDAGE | 41 | |  |  |
| CYTOSKELETON | 38 | |  |  |
| SPORE | 20 | |  |  |
...
398 records are grounded in GO; 59 carry minted identifiers. 373 list components, 456 carry causal graphs (2028 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
