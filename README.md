...
**264 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 107 | | PROPOSED | 264 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
215 records are grounded in GO; 49 carry minted identifiers. 235 list components, 264 carry causal graphs (1234 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
