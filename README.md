...
**150 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 34 | | PROPOSED | 150 |
| APPENDAGE | 33 | |  |  |
| OTHER | 21 | |  |  |
| CYTOSKELETON | 18 | |  |  |
| SECRETION_SYSTEM | 10 | |  |  |
...
118 records are grounded in GO; 32 carry minted identifiers. 150 list components, 150 carry causal graphs (831 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
