...
**114 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 28 | | PROPOSED | 114 |
...
99 records are grounded in GO; 15 carry minted identifiers. 114 list components, 114 carry causal graphs (673 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
