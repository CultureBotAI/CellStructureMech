...
**154 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 36 | | PROPOSED | 154 |
| APPENDAGE | 34 | |  |  |
| OTHER | 21 | |  |  |
| CYTOSKELETON | 18 | |  |  |
| SECRETION_SYSTEM | 10 | |  |  |
...
122 records are grounded in GO; 32 carry minted identifiers. 154 list components, 154 carry causal graphs (859 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
