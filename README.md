...
**34 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 6 | | PROPOSED | 34 |
| SECRETION_SYSTEM | 5 | |  |  |
| APPENDAGE | 4 | |  |  |
| ENVELOPE | 4 | |  |  |
| MICROCOMPARTMENT | 4 | |  |  |
...
32 records are grounded in GO; 2 carry minted identifiers. 34 list components, 34 carry causal graphs (245 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
