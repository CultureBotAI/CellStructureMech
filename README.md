...
**590 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 590 |
| OTHER | 122 | |  |  |
...
523 records are grounded in GO; 67 carry minted identifiers. 480 list components, 589 carry causal graphs (2532 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
