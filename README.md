...
**607 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 607 |
| OTHER | 139 | |  |  |
...
540 records are grounded in GO; 67 carry minted identifiers. 497 list components, 606 carry causal graphs (2642 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
