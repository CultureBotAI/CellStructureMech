...
**352 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 164 | | PROPOSED | 352 |
| OTHER | 43 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 30 | |  |  |
| ENVELOPE | 13 | |  |  |
...
298 records are grounded in GO; 54 carry minted identifiers. 290 list components, 352 carry causal graphs (1528 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
