...
**439 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 185 | | PROPOSED | 439 |
| OTHER | 95 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 38 | |  |  |
| ENVELOPE | 15 | |  |  |
...
381 records are grounded in GO; 58 carry minted identifiers. 362 list components, 439 carry causal graphs (1964 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
