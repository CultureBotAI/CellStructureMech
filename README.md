...
**562 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 562 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
...
495 records are grounded in GO; 67 carry minted identifiers. 460 list components, 561 carry causal graphs (2423 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
