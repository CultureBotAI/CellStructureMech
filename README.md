...
**105 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 28 | | PROPOSED | 105 |
...
90 records are grounded in GO; 15 carry minted identifiers. 105 list components, 105 carry causal graphs (640 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
