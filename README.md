...
**155 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 36 | | PROPOSED | 155 |
| APPENDAGE | 34 | |  |  |
| OTHER | 21 | |  |  |
| CYTOSKELETON | 18 | |  |  |
| ENVELOPE | 10 | |  |  |
...
123 records are grounded in GO; 32 carry minted identifiers. 155 list components, 155 carry causal graphs (863 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
