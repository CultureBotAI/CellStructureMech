...
**227 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 75 | | PROPOSED | 227 |
| APPENDAGE | 36 | |  |  |
| OTHER | 31 | |  |  |
| CYTOSKELETON | 22 | |  |  |
| ENVELOPE | 11 | |  |  |
...
190 records are grounded in GO; 37 carry minted identifiers. 211 list components, 227 carry causal graphs (1128 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
