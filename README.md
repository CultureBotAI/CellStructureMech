...
**60 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 22 | | PROPOSED | 60 |
| SECRETION_SYSTEM | 9 | |  |  |
...
54 records are grounded in GO; 6 carry minted identifiers. 60 list components, 60 carry causal graphs (419 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
