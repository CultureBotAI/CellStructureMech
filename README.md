...
**16 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| ENVELOPE | 4 | | PROPOSED | 16 |
| APPENDAGE | 2 | |  |  |
| CYTOSKELETON | 1 | |  |  |
...
15 records are grounded in GO; 1 carry minted identifiers. 16 list components, 7 carry causal graphs (42 evidence-backed edges), 5 link to TraitMech traits, and 4 carry licensed, cited imaging evidence.
