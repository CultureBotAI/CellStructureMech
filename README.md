...
**67 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 67 |
| MEMBRANE_ORGANELLE | 11 | |  |  |
| SECRETION_SYSTEM | 9 | |  |  |
| MICROCOMPARTMENT | 6 | |  |  |
| ENVELOPE | 4 | |  |  |
| OTHER | 3 | |  |  |
...
61 records are grounded in GO; 6 carry minted identifiers. 67 list components, 67 carry causal graphs (461 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
