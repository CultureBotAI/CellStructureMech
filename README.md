...
**69 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 69 |
...
63 records are grounded in GO; 6 carry minted identifiers. 69 list components, 69 carry causal graphs (478 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
