...
**549 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 549 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| RIBONUCLEOPROTEIN | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
| SPORE | 21 | |  |  |
| ENVELOPE | 16 | |  |  |
| SECRETION_SYSTEM | 15 | |  |  |
...
482 records are grounded in GO; 67 carry minted identifiers. 447 list components, 548 carry causal graphs (2394 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
