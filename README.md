...
**456 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 192 | | PROPOSED | 456 |
| OTHER | 95 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 38 | |  |  |
| SPORE | 20 | |  |  |
...
398 records are grounded in GO; 58 carry minted identifiers. 372 list components, 455 carry causal graphs (2023 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
