...
**85 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 85 |
| MEMBRANE_ORGANELLE | 19 | |  |  |
| SECRETION_SYSTEM | 9 | |  |  |
| INCLUSION | 7 | |  |  |
| MICROCOMPARTMENT | 6 | |  |  |
| OTHER | 5 | |  |  |
...
75 records are grounded in GO; 10 carry minted identifiers. 85 list components, 85 carry causal graphs (550 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
