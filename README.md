...
**577 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 577 |
| OTHER | 112 | |  |  |
| RIBONUCLEOPROTEIN | 66 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
| SPORE | 21 | |  |  |
...
510 records are grounded in GO; 67 carry minted identifiers. 467 list components, 576 carry causal graphs (2466 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
