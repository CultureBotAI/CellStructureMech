...
**587 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 587 |
| OTHER | 119 | |  |  |
...
520 records are grounded in GO; 67 carry minted identifiers. 477 list components, 586 carry causal graphs (2522 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
