...
**421 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 421 |
| OTHER | 94 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 32 | |  |  |
| ENVELOPE | 14 | |  |  |
...
367 records are grounded in GO; 54 carry minted identifiers. 345 list components, 421 carry causal graphs (1891 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
