...
**385 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 385 |
| OTHER | 60 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
331 records are grounded in GO; 54 carry minted identifiers. 319 list components, 385 carry causal graphs (1696 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
