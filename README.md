...
**531 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 531 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
...
464 records are grounded in GO; 67 carry minted identifiers. 429 list components, 530 carry causal graphs (2356 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
