...
**110 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 28 | | PROPOSED | 110 |
...
95 records are grounded in GO; 15 carry minted identifiers. 110 list components, 110 carry causal graphs (661 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
