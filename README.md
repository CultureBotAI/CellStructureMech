...
**383 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 383 |
| OTHER | 58 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
329 records are grounded in GO; 54 carry minted identifiers. 317 list components, 383 carry causal graphs (1679 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
