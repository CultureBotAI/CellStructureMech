...
**90 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 90 |
| MEMBRANE_ORGANELLE | 21 | |  |  |
| SECRETION_SYSTEM | 9 | |  |  |
| INCLUSION | 7 | |  |  |
| OTHER | 7 | |  |  |
| MICROCOMPARTMENT | 6 | |  |  |
...
80 records are grounded in GO; 10 carry minted identifiers. 90 list components, 90 carry causal graphs (569 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
