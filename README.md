...
**417 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 417 |
| OTHER | 92 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
363 records are grounded in GO; 54 carry minted identifiers. 341 list components, 417 carry causal graphs (1869 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
