...
**362 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 169 | | PROPOSED | 362 |
| OTHER | 45 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
308 records are grounded in GO; 54 carry minted identifiers. 300 list components, 362 carry causal graphs (1570 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
