...
**331 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 159 | | PROPOSED | 331 |
| OTHER | 40 | |  |  |
| APPENDAGE | 39 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENERGY_COMPLEX | 12 | |  |  |
...
277 records are grounded in GO; 54 carry minted identifiers. 274 list components, 331 carry causal graphs (1464 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
