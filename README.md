...
**106 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 28 | | PROPOSED | 106 |
...
91 records are grounded in GO; 15 carry minted identifiers. 106 list components, 106 carry causal graphs (643 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
