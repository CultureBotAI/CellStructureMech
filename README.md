...
**182 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 45 | | PROPOSED | 182 |
| APPENDAGE | 35 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 10 | |  |  |
...
150 records are grounded in GO; 32 carry minted identifiers. 182 list components, 182 carry causal graphs (992 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
