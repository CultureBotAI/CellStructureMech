...
**184 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 47 | | PROPOSED | 184 |
| APPENDAGE | 35 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 10 | |  |  |
...
152 records are grounded in GO; 32 carry minted identifiers. 184 list components, 184 carry causal graphs (1000 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
