...
**390 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 390 |
| OTHER | 65 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
336 records are grounded in GO; 54 carry minted identifiers. 324 list components, 390 carry causal graphs (1733 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
