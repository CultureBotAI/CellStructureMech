...
**31 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 5 | | PROPOSED | 31 |
| SECRETION_SYSTEM | 5 | |  |  |
| APPENDAGE | 4 | |  |  |
| ENVELOPE | 4 | |  |  |
...
29 records are grounded in GO; 2 carry minted identifiers. 31 list components, 31 carry causal graphs (227 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
