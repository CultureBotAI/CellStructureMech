...
**173 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 41 | | PROPOSED | 173 |
| APPENDAGE | 34 | |  |  |
| OTHER | 26 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 10 | |  |  |
...
141 records are grounded in GO; 32 carry minted identifiers. 173 list components, 173 carry causal graphs (963 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
