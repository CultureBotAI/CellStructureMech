...
**495 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 495 |
| OTHER | 101 | |  |  |
| CYTOSKELETON | 59 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 21 | |  |  |
...
429 records are grounded in GO; 66 carry minted identifiers. 395 list components, 494 carry causal graphs (2191 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
