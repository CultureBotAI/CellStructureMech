...
**585 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 585 |
| OTHER | 117 | |  |  |
...
518 records are grounded in GO; 67 carry minted identifiers. 475 list components, 584 carry causal graphs (2509 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
