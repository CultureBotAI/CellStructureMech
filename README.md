...
**605 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 605 |
| OTHER | 137 | |  |  |
...
538 records are grounded in GO; 67 carry minted identifiers. 495 list components, 604 carry causal graphs (2635 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
