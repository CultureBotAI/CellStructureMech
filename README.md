...
**244 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 87 | | PROPOSED | 244 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
205 records are grounded in GO; 39 carry minted identifiers. 222 list components, 244 carry causal graphs (1181 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
