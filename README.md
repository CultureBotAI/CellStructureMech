...
**423 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 178 | | PROPOSED | 423 |
| OTHER | 94 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 33 | |  |  |
| ENVELOPE | 14 | |  |  |
...
368 records are grounded in GO; 55 carry minted identifiers. 347 list components, 423 carry causal graphs (1898 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
