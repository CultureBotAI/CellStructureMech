...
**304 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 145 | | PROPOSED | 304 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
251 records are grounded in GO; 53 carry minted identifiers. 260 list components, 304 carry causal graphs (1348 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
