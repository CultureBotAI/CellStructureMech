...
**400 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 400 |
| OTHER | 75 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
346 records are grounded in GO; 54 carry minted identifiers. 334 list components, 400 carry causal graphs (1803 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
