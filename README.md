...
**127 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 29 | | PROPOSED | 127 |
| MEMBRANE_ORGANELLE | 24 | |  |  |
| OTHER | 18 | |  |  |
| CYTOSKELETON | 16 | |  |  |
| SECRETION_SYSTEM | 9 | |  |  |
| ENVELOPE | 8 | |  |  |
...
100 records are grounded in GO; 27 carry minted identifiers. 127 list components, 127 carry causal graphs (720 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
