...
**341 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 159 | | PROPOSED | 341 |
| APPENDAGE | 40 | |  |  |
| OTHER | 40 | |  |  |
| CYTOSKELETON | 29 | |  |  |
| ENERGY_COMPLEX | 12 | |  |  |
...
287 records are grounded in GO; 54 carry minted identifiers. 282 list components, 341 carry causal graphs (1490 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
