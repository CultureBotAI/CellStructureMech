...
**389 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 389 |
| OTHER | 64 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
335 records are grounded in GO; 54 carry minted identifiers. 323 list components, 389 carry causal graphs (1726 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
