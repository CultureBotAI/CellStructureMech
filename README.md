...
**277 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 118 | | PROPOSED | 277 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
228 records are grounded in GO; 49 carry minted identifiers. 242 list components, 277 carry causal graphs (1268 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
