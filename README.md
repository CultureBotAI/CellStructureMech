...
**561 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 561 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| RIBONUCLEOPROTEIN | 54 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
| SPORE | 21 | |  |  |
| ENVELOPE | 16 | |  |  |
...
494 records are grounded in GO; 67 carry minted identifiers. 459 list components, 560 carry causal graphs (2421 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
