...
**174 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 42 | | PROPOSED | 174 |
| APPENDAGE | 34 | |  |  |
| OTHER | 26 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 10 | |  |  |
...
142 records are grounded in GO; 32 carry minted identifiers. 174 list components, 174 carry causal graphs (968 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
