...
**345 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 161 | | PROPOSED | 345 |
| OTHER | 42 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 29 | |  |  |
| ENERGY_COMPLEX | 12 | |  |  |
...
291 records are grounded in GO; 54 carry minted identifiers. 285 list components, 345 carry causal graphs (1510 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
