...
**242 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 85 | | PROPOSED | 242 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
203 records are grounded in GO; 39 carry minted identifiers. 221 list components, 242 carry causal graphs (1175 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
