...
**40 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| SECRETION_SYSTEM | 7 | | PROPOSED | 40 |
| APPENDAGE | 6 | |  |  |
...
36 records are grounded in GO; 4 carry minted identifiers. 40 list components, 40 carry causal graphs (285 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
