...
**501 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 501 |
| OTHER | 103 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 21 | |  |  |
...
435 records are grounded in GO; 66 carry minted identifiers. 399 list components, 500 carry causal graphs (2223 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
