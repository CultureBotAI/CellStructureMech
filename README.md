...
**472 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 193 | | PROPOSED | 472 |
| OTHER | 95 | |  |  |
| CYTOSKELETON | 46 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 20 | |  |  |
...
406 records are grounded in GO; 66 carry minted identifiers. 387 list components, 471 carry causal graphs (2099 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
