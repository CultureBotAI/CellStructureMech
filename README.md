...
**365 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 171 | | PROPOSED | 365 |
| OTHER | 46 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
311 records are grounded in GO; 54 carry minted identifiers. 303 list components, 365 carry causal graphs (1588 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
