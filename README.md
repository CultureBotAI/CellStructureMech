...
**443 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 189 | | PROPOSED | 443 |
| OTHER | 95 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 38 | |  |  |
| ENVELOPE | 15 | |  |  |
...
385 records are grounded in GO; 58 carry minted identifiers. 365 list components, 443 carry causal graphs (1979 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
