...
**401 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 401 |
| OTHER | 76 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
347 records are grounded in GO; 54 carry minted identifiers. 335 list components, 401 carry causal graphs (1806 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
