...
**251 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 94 | | PROPOSED | 251 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
211 records are grounded in GO; 40 carry minted identifiers. 227 list components, 251 carry causal graphs (1198 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
