...
**524 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 524 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
...
457 records are grounded in GO; 67 carry minted identifiers. 422 list components, 523 carry causal graphs (2337 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
