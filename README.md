...
**603 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 603 |
| OTHER | 135 | |  |  |
...
536 records are grounded in GO; 67 carry minted identifiers. 493 list components, 602 carry causal graphs (2631 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
