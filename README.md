...
**409 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 409 |
| OTHER | 84 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
355 records are grounded in GO; 54 carry minted identifiers. 337 list components, 409 carry causal graphs (1833 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
