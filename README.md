...
**394 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 394 |
| OTHER | 69 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
340 records are grounded in GO; 54 carry minted identifiers. 328 list components, 394 carry causal graphs (1770 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
