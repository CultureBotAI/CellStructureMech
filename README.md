...
**370 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 175 | | PROPOSED | 370 |
| OTHER | 47 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
316 records are grounded in GO; 54 carry minted identifiers. 305 list components, 370 carry causal graphs (1611 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
