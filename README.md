...
**384 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 384 |
| OTHER | 59 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
330 records are grounded in GO; 54 carry minted identifiers. 318 list components, 384 carry causal graphs (1687 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
