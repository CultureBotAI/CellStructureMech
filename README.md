...
**131 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 32 | | PROPOSED | 131 |
...
101 records are grounded in GO; 30 carry minted identifiers. 131 list components, 131 carry causal graphs (736 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
