...
**411 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 411 |
| OTHER | 86 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
357 records are grounded in GO; 54 carry minted identifiers. 337 list components, 411 carry causal graphs (1837 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
