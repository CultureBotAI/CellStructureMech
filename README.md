...
**250 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 93 | | PROPOSED | 250 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
210 records are grounded in GO; 40 carry minted identifiers. 226 list components, 250 carry causal graphs (1196 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
