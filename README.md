...
**297 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 138 | | PROPOSED | 297 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
248 records are grounded in GO; 49 carry minted identifiers. 259 list components, 297 carry causal graphs (1333 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
