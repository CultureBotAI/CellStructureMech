...
**229 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 75 | | PROPOSED | 229 |
| APPENDAGE | 36 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
192 records are grounded in GO; 37 carry minted identifiers. 212 list components, 229 carry causal graphs (1137 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
