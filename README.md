...
**377 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 377 |
| OTHER | 52 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
323 records are grounded in GO; 54 carry minted identifiers. 311 list components, 377 carry causal graphs (1645 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
