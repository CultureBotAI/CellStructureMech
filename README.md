...
**116 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 28 | | PROPOSED | 116 |
...
99 records are grounded in GO; 17 carry minted identifiers. 116 list components, 116 carry causal graphs (680 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
