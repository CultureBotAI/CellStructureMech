...
**354 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 164 | | PROPOSED | 354 |
| OTHER | 43 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENERGY_COMPLEX | 13 | |  |  |
...
300 records are grounded in GO; 54 carry minted identifiers. 292 list components, 354 carry causal graphs (1535 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
