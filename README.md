...
**86 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 86 |
| MEMBRANE_ORGANELLE | 20 | |  |  |
| SECRETION_SYSTEM | 9 | |  |  |
| INCLUSION | 7 | |  |  |
| MICROCOMPARTMENT | 6 | |  |  |
| OTHER | 5 | |  |  |
...
76 records are grounded in GO; 10 carry minted identifiers. 86 list components, 86 carry causal graphs (553 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
