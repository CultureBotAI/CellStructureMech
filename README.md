...
**482 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 193 | | PROPOSED | 482 |
| OTHER | 95 | |  |  |
| CYTOSKELETON | 56 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 20 | |  |  |
...
416 records are grounded in GO; 66 carry minted identifiers. 390 list components, 481 carry causal graphs (2140 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
