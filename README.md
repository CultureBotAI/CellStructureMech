...
**248 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 91 | | PROPOSED | 248 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
208 records are grounded in GO; 40 carry minted identifiers. 226 list components, 248 carry causal graphs (1190 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
