...
**53 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 15 | | PROPOSED | 53 |
| SECRETION_SYSTEM | 9 | |  |  |
...
47 records are grounded in GO; 6 carry minted identifiers. 53 list components, 53 carry causal graphs (369 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
