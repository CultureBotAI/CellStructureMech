...
**252 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 95 | | PROPOSED | 252 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
212 records are grounded in GO; 40 carry minted identifiers. 228 list components, 252 carry causal graphs (1203 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
