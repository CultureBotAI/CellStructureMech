...
**575 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 575 |
| OTHER | 112 | |  |  |
| RIBONUCLEOPROTEIN | 64 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
| SPORE | 21 | |  |  |
...
508 records are grounded in GO; 67 carry minted identifiers. 465 list components, 574 carry causal graphs (2462 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
