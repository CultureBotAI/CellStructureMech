...
**455 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 192 | | PROPOSED | 455 |
| OTHER | 95 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 38 | |  |  |
| SPORE | 20 | |  |  |
...
397 records are grounded in GO; 58 carry minted identifiers. 371 list components, 454 carry causal graphs (2018 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
