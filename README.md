...
**236 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 79 | | PROPOSED | 236 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
197 records are grounded in GO; 39 carry minted identifiers. 218 list components, 236 carry causal graphs (1160 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
