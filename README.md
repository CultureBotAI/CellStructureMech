...
**112 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 28 | | PROPOSED | 112 |
...
97 records are grounded in GO; 15 carry minted identifiers. 112 list components, 112 carry causal graphs (665 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
