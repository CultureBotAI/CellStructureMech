...
**429 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 178 | | PROPOSED | 429 |
| OTHER | 95 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 36 | |  |  |
| ENVELOPE | 14 | |  |  |
...
371 records are grounded in GO; 58 carry minted identifiers. 353 list components, 429 carry causal graphs (1918 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
