...
**49 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 11 | | PROPOSED | 49 |
| SECRETION_SYSTEM | 9 | |  |  |
...
43 records are grounded in GO; 6 carry minted identifiers. 49 list components, 49 carry causal graphs (346 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
