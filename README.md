...
**63 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 63 |
| SECRETION_SYSTEM | 9 | |  |  |
| MEMBRANE_ORGANELLE | 7 | |  |  |
| MICROCOMPARTMENT | 6 | |  |  |
| ENVELOPE | 4 | |  |  |
| OTHER | 3 | |  |  |
| CYTOSKELETON | 2 | |  |  |
...
57 records are grounded in GO; 6 carry minted identifiers. 63 list components, 63 carry causal graphs (438 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
