...
**84 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 84 |
| MEMBRANE_ORGANELLE | 18 | |  |  |
| SECRETION_SYSTEM | 9 | |  |  |
| INCLUSION | 7 | |  |  |
| MICROCOMPARTMENT | 6 | |  |  |
| OTHER | 5 | |  |  |
...
75 records are grounded in GO; 9 carry minted identifiers. 84 list components, 84 carry causal graphs (546 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
