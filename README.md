...
**262 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 105 | | PROPOSED | 262 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
213 records are grounded in GO; 49 carry minted identifiers. 233 list components, 262 carry causal graphs (1226 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
