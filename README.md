...
**286 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 127 | | PROPOSED | 286 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
237 records are grounded in GO; 49 carry minted identifiers. 250 list components, 286 carry causal graphs (1300 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
