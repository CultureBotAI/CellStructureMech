...
**152 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 35 | | PROPOSED | 152 |
| APPENDAGE | 34 | |  |  |
| OTHER | 21 | |  |  |
| CYTOSKELETON | 18 | |  |  |
| SECRETION_SYSTEM | 10 | |  |  |
...
120 records are grounded in GO; 32 carry minted identifiers. 152 list components, 152 carry causal graphs (847 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
