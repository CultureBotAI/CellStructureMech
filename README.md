...
**188 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 50 | | PROPOSED | 188 |
| APPENDAGE | 35 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
156 records are grounded in GO; 32 carry minted identifiers. 188 list components, 188 carry causal graphs (1015 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
