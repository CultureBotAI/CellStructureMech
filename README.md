...
**589 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 589 |
| OTHER | 121 | |  |  |
...
522 records are grounded in GO; 67 carry minted identifiers. 479 list components, 588 carry causal graphs (2529 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
