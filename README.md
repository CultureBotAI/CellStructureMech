...
**349 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 163 | | PROPOSED | 349 |
| OTHER | 43 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 30 | |  |  |
| ENERGY_COMPLEX | 12 | |  |  |
...
295 records are grounded in GO; 54 carry minted identifiers. 287 list components, 349 carry causal graphs (1519 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
