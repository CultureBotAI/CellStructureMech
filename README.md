...
**327 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 159 | | PROPOSED | 327 |
| APPENDAGE | 38 | |  |  |
| OTHER | 37 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENERGY_COMPLEX | 12 | |  |  |
...
273 records are grounded in GO; 54 carry minted identifiers. 270 list components, 327 carry causal graphs (1446 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
