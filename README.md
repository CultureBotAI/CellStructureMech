...
**594 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 594 |
| OTHER | 126 | |  |  |
...
527 records are grounded in GO; 67 carry minted identifiers. 484 list components, 593 carry causal graphs (2551 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
