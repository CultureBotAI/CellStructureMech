...
**181 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 45 | | PROPOSED | 181 |
| APPENDAGE | 35 | |  |  |
| OTHER | 28 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 10 | |  |  |
...
149 records are grounded in GO; 32 carry minted identifiers. 181 list components, 181 carry causal graphs (990 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
