...
**187 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 49 | | PROPOSED | 187 |
| APPENDAGE | 35 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
155 records are grounded in GO; 32 carry minted identifiers. 187 list components, 187 carry causal graphs (1011 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
