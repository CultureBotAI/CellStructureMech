...
**552 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 552 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
...
485 records are grounded in GO; 67 carry minted identifiers. 450 list components, 551 carry causal graphs (2398 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
