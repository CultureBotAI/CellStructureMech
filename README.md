...
**353 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 164 | | PROPOSED | 353 |
| OTHER | 43 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 13 | |  |  |
...
299 records are grounded in GO; 54 carry minted identifiers. 291 list components, 353 carry causal graphs (1530 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
