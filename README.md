...
**569 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 569 |
| OTHER | 109 | |  |  |
...
502 records are grounded in GO; 67 carry minted identifiers. 463 list components, 568 carry causal graphs (2442 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
