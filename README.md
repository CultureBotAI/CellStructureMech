...
**246 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 89 | | PROPOSED | 246 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
207 records are grounded in GO; 39 carry minted identifiers. 224 list components, 246 carry causal graphs (1185 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
