...
**239 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 82 | | PROPOSED | 239 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
200 records are grounded in GO; 39 carry minted identifiers. 220 list components, 239 carry causal graphs (1168 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
