...
**179 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 45 | | PROPOSED | 179 |
| APPENDAGE | 34 | |  |  |
| OTHER | 27 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 10 | |  |  |
...
147 records are grounded in GO; 32 carry minted identifiers. 179 list components, 179 carry causal graphs (986 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
