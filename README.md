...
**388 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 388 |
| OTHER | 63 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
334 records are grounded in GO; 54 carry minted identifiers. 322 list components, 388 carry causal graphs (1717 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
