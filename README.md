...
**303 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 144 | | PROPOSED | 303 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
250 records are grounded in GO; 53 carry minted identifiers. 259 list components, 303 carry causal graphs (1345 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
