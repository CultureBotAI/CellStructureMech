...
**241 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 84 | | PROPOSED | 241 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
202 records are grounded in GO; 39 carry minted identifiers. 221 list components, 241 carry causal graphs (1173 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
