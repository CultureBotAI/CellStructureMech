...
**399 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 399 |
| OTHER | 74 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
345 records are grounded in GO; 54 carry minted identifiers. 333 list components, 399 carry causal graphs (1800 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
