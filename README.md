...
**463 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 192 | | PROPOSED | 463 |
| OTHER | 95 | |  |  |
| APPENDAGE | 42 | |  |  |
| CYTOSKELETON | 38 | |  |  |
| SPORE | 20 | |  |  |
...
398 records are grounded in GO; 65 carry minted identifiers. 379 list components, 462 carry causal graphs (2058 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
