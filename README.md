...
**136 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 33 | | PROPOSED | 136 |
| MEMBRANE_ORGANELLE | 27 | |  |  |
| OTHER | 18 | |  |  |
| CYTOSKELETON | 17 | |  |  |
| SECRETION_SYSTEM | 10 | |  |  |
| ENVELOPE | 8 | |  |  |
...
104 records are grounded in GO; 32 carry minted identifiers. 136 list components, 136 carry causal graphs (757 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
