...
**161 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 40 | | PROPOSED | 161 |
| APPENDAGE | 34 | |  |  |
| OTHER | 22 | |  |  |
| CYTOSKELETON | 18 | |  |  |
| ENVELOPE | 10 | |  |  |
...
129 records are grounded in GO; 32 carry minted identifiers. 161 list components, 161 carry causal graphs (904 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
