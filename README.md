...
**325 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 159 | | PROPOSED | 325 |
| APPENDAGE | 38 | |  |  |
| OTHER | 36 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 12 | |  |  |
...
271 records are grounded in GO; 54 carry minted identifiers. 269 list components, 325 carry causal graphs (1439 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
