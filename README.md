...
**473 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 193 | | PROPOSED | 473 |
| OTHER | 95 | |  |  |
| CYTOSKELETON | 47 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 20 | |  |  |
...
407 records are grounded in GO; 66 carry minted identifiers. 388 list components, 472 carry causal graphs (2102 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
