...
**564 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 564 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
...
497 records are grounded in GO; 67 carry minted identifiers. 462 list components, 563 carry causal graphs (2428 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
