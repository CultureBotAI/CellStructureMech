...
**137 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 33 | | PROPOSED | 137 |
| MEMBRANE_ORGANELLE | 28 | |  |  |
| OTHER | 18 | |  |  |
| CYTOSKELETON | 17 | |  |  |
| SECRETION_SYSTEM | 10 | |  |  |
| ENVELOPE | 8 | |  |  |
...
105 records are grounded in GO; 32 carry minted identifiers. 137 list components, 137 carry causal graphs (762 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
