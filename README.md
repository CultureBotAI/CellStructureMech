...
**159 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 39 | | PROPOSED | 159 |
| APPENDAGE | 34 | |  |  |
| OTHER | 22 | |  |  |
| CYTOSKELETON | 18 | |  |  |
| ENVELOPE | 10 | |  |  |
...
127 records are grounded in GO; 32 carry minted identifiers. 159 list components, 159 carry causal graphs (889 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
