...
**75 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 75 |
...
69 records are grounded in GO; 6 carry minted identifiers. 75 list components, 75 carry causal graphs (516 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
