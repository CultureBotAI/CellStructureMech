...
**287 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 128 | | PROPOSED | 287 |
| APPENDAGE | 38 | |  |  |
| OTHER | 33 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
238 records are grounded in GO; 49 carry minted identifiers. 251 list components, 287 carry causal graphs (1304 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
