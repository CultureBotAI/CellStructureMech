...
**568 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 568 |
| OTHER | 108 | |  |  |
...
501 records are grounded in GO; 67 carry minted identifiers. 463 list components, 567 carry causal graphs (2440 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
