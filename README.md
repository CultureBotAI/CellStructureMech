...
**430 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 178 | | PROPOSED | 430 |
| OTHER | 95 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 37 | |  |  |
| ENVELOPE | 14 | |  |  |
...
372 records are grounded in GO; 58 carry minted identifiers. 354 list components, 430 carry causal graphs (1922 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
