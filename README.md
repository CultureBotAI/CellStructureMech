...
**68 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 68 |
| MEMBRANE_ORGANELLE | 12 | |  |  |
| SECRETION_SYSTEM | 9 | |  |  |
| MICROCOMPARTMENT | 6 | |  |  |
| ENVELOPE | 4 | |  |  |
| OTHER | 3 | |  |  |
...
62 records are grounded in GO; 6 carry minted identifiers. 68 list components, 68 carry causal graphs (470 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
