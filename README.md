...
**175 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 43 | | PROPOSED | 175 |
| APPENDAGE | 34 | |  |  |
| OTHER | 26 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 10 | |  |  |
...
143 records are grounded in GO; 32 carry minted identifiers. 175 list components, 175 carry causal graphs (970 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
