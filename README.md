...
**602 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 602 |
| OTHER | 134 | |  |  |
...
535 records are grounded in GO; 67 carry minted identifiers. 492 list components, 601 carry causal graphs (2629 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
