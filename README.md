...
**163 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 40 | | PROPOSED | 163 |
| APPENDAGE | 34 | |  |  |
| OTHER | 24 | |  |  |
| CYTOSKELETON | 18 | |  |  |
| ENVELOPE | 10 | |  |  |
...
131 records are grounded in GO; 32 carry minted identifiers. 163 list components, 163 carry causal graphs (921 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
