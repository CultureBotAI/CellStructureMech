...
**514 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 514 |
| OTHER | 107 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
...
447 records are grounded in GO; 67 carry minted identifiers. 412 list components, 513 carry causal graphs (2305 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
