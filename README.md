...
**51 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 13 | | PROPOSED | 51 |
| SECRETION_SYSTEM | 9 | |  |  |
...
45 records are grounded in GO; 6 carry minted identifiers. 51 list components, 51 carry causal graphs (356 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
