...
**169 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 40 | | PROPOSED | 169 |
| APPENDAGE | 34 | |  |  |
| OTHER | 26 | |  |  |
| CYTOSKELETON | 19 | |  |  |
| ENVELOPE | 10 | |  |  |
...
137 records are grounded in GO; 32 carry minted identifiers. 169 list components, 169 carry causal graphs (947 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
