...
**210 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 69 | | PROPOSED | 210 |
| APPENDAGE | 36 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
178 records are grounded in GO; 32 carry minted identifiers. 204 list components, 210 carry causal graphs (1072 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
