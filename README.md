...
**464 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 193 | | PROPOSED | 464 |
| OTHER | 95 | |  |  |
| APPENDAGE | 42 | |  |  |
| CYTOSKELETON | 38 | |  |  |
| SPORE | 20 | |  |  |
...
398 records are grounded in GO; 66 carry minted identifiers. 380 list components, 463 carry causal graphs (2062 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
