...
**454 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 191 | | PROPOSED | 454 |
| OTHER | 95 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 38 | |  |  |
| SPORE | 20 | |  |  |
...
396 records are grounded in GO; 58 carry minted identifiers. 370 list components, 453 carry causal graphs (2013 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
