...
**469 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 193 | | PROPOSED | 469 |
| OTHER | 95 | |  |  |
| CYTOSKELETON | 43 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 20 | |  |  |
...
403 records are grounded in GO; 66 carry minted identifiers. 385 list components, 468 carry causal graphs (2086 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
