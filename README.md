...
**500 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 500 |
| OTHER | 103 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 21 | |  |  |
...
434 records are grounded in GO; 66 carry minted identifiers. 398 list components, 499 carry causal graphs (2218 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
