...
**351 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 164 | | PROPOSED | 351 |
| OTHER | 43 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 30 | |  |  |
| ENVELOPE | 13 | |  |  |
...
297 records are grounded in GO; 54 carry minted identifiers. 289 list components, 351 carry causal graphs (1525 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
