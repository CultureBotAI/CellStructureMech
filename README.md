...
**555 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 555 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
...
488 records are grounded in GO; 67 carry minted identifiers. 453 list components, 554 carry causal graphs (2403 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
