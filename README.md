...
**493 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 493 |
| OTHER | 100 | |  |  |
| CYTOSKELETON | 58 | |  |  |
| APPENDAGE | 42 | |  |  |
| SPORE | 21 | |  |  |
...
427 records are grounded in GO; 66 carry minted identifiers. 395 list components, 492 carry causal graphs (2178 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
