...
**528 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 528 |
| OTHER | 108 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
...
461 records are grounded in GO; 67 carry minted identifiers. 426 list components, 527 carry causal graphs (2349 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
