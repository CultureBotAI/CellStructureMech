...
**572 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 572 |
| OTHER | 112 | |  |  |
| RIBONUCLEOPROTEIN | 61 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 25 | |  |  |
| SPORE | 21 | |  |  |
...
505 records are grounded in GO; 67 carry minted identifiers. 463 list components, 571 carry causal graphs (2451 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
