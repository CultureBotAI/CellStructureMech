...
**41 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| SECRETION_SYSTEM | 8 | | PROPOSED | 41 |
| APPENDAGE | 6 | |  |  |
...
37 records are grounded in GO; 4 carry minted identifiers. 41 list components, 41 carry causal graphs (292 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
