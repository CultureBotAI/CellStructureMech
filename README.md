...
**237 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 80 | | PROPOSED | 237 |
| APPENDAGE | 38 | |  |  |
| OTHER | 32 | |  |  |
| CYTOSKELETON | 23 | |  |  |
| ENVELOPE | 11 | |  |  |
...
198 records are grounded in GO; 39 carry minted identifiers. 219 list components, 237 carry causal graphs (1163 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
