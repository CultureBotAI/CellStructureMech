...
**583 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 583 |
| OTHER | 115 | |  |  |
...
516 records are grounded in GO; 67 carry minted identifiers. 473 list components, 582 carry causal graphs (2490 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
