...
**130 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 31 | | PROPOSED | 130 |
...
101 records are grounded in GO; 29 carry minted identifiers. 130 list components, 130 carry causal graphs (732 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
