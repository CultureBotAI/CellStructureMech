...
**73 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| APPENDAGE | 23 | | PROPOSED | 73 |
...
67 records are grounded in GO; 6 carry minted identifiers. 73 list components, 73 carry causal graphs (506 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
