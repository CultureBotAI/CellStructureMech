...
**392 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 392 |
| OTHER | 67 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
338 records are grounded in GO; 54 carry minted identifiers. 326 list components, 392 carry causal graphs (1752 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
