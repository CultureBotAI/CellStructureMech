...
**396 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 396 |
| OTHER | 71 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
342 records are grounded in GO; 54 carry minted identifiers. 330 list components, 396 carry causal graphs (1780 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
