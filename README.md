...
**213 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 72 | | PROPOSED | 213 |
| APPENDAGE | 36 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
181 records are grounded in GO; 32 carry minted identifiers. 206 list components, 213 carry causal graphs (1078 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
