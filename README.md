...
**199 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 61 | | PROPOSED | 199 |
| APPENDAGE | 35 | |  |  |
| OTHER | 29 | |  |  |
| CYTOSKELETON | 20 | |  |  |
| ENVELOPE | 11 | |  |  |
...
167 records are grounded in GO; 32 carry minted identifiers. 198 list components, 199 carry causal graphs (1046 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
