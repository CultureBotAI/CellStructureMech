...
**387 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 177 | | PROPOSED | 387 |
| OTHER | 62 | |  |  |
| APPENDAGE | 40 | |  |  |
| CYTOSKELETON | 31 | |  |  |
| ENVELOPE | 14 | |  |  |
...
333 records are grounded in GO; 54 carry minted identifiers. 321 list components, 387 carry causal graphs (1712 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
