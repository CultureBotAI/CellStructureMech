...
**508 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| MEMBRANE_ORGANELLE | 196 | | PROPOSED | 508 |
| OTHER | 103 | |  |  |
| CYTOSKELETON | 60 | |  |  |
| APPENDAGE | 42 | |  |  |
| ENERGY_COMPLEX | 23 | |  |  |
...
441 records are grounded in GO; 67 carry minted identifiers. 406 list components, 507 carry causal graphs (2271 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
