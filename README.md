...
**46 structure records** are currently committed.

| Category | Records | | Status | Records |
|---|---:|---|---|---:|
| SECRETION_SYSTEM | 9 | | PROPOSED | 46 |
| APPENDAGE | 8 | |  |  |
...
40 records are grounded in GO; 6 carry minted identifiers. 46 list components, 46 carry causal graphs (322 evidence-backed edges), 8 link to TraitMech traits, and 5 carry licensed, cited imaging evidence.
